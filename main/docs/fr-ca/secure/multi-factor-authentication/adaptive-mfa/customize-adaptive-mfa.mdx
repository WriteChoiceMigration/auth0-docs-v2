...
Vous pouvez personnaliser l’authentification multifacteur (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip>) adaptative pour une variété de scénarios avec [Auth0 Actions](/docs/fr-ca/customize/actions).
...
<td>Les valeurs de propriété de l’objet <code>details</code> sont équivalentes.</td>
</tr>
<tr>
<td><code>partial_match</code></td>
<td>Les valeurs de propriété de l’objet <code>details</code> sont similaires.</td>
</tr>
<tr>
<td><code>no_match</code></td>
<td>Les valeurs de propriété de l’objet <code>details</code> sont différentes.</td>
</tr>
<tr>
...
| -- | -- | -- | | -- |
| `ip` | Adresse IP de l’appareil. | Toute adresse IPv4 ou IPv6 valide. |
...
| `source` | Nom de la source de renseignements sur les menaces pour la liste de refus. | chaîne de caractères | Tout texte valide. |
| `category` | Catégorie indiquant pourquoi l’adresse IP n’est pas fiable. | Chaîne de caractères | `abuse`, `anonymizer`, `datacenter`, `reputation`, `unroutable` |
...
<td>chaîne</td>
<td>Numéro valide incluant <code>countryCode</code></td>
</tr>
</tbody>
</table>
