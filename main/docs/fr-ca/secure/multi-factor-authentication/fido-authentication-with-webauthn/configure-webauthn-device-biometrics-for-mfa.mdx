...
L’utilisateur doit avoir activé une autre inscription <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> avant d’utiliser la biométrie de l’appareil.
