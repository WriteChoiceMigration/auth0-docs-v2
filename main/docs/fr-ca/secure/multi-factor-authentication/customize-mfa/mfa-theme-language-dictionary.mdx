...
'description': "Cette section décrit les options de configuration de la page MFA hébergée pour personnaliser les propriétés du thème des pages MFA."
'og:title': "Dictionnaire de langue de thème MFA"
'og:description': "Cette section décrit les options de configuration de la page MFA hébergée pour personnaliser les propriétés du thème des pages MFA."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/img/share-image.png"
'twitter:title': "Dictionnaire de langue de thème MFA"
'twitter:description': "Cette section décrit les options de configuration de la page MFA hébergée pour personnaliser les propriétés du thème des pages MFA."
---
...
`languageDictionary` peut être utilisé pour remplacer le texte dans de nombreux domaines du processus <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> avec l’expérience de connexion classique. Utilisez le format suivant :
