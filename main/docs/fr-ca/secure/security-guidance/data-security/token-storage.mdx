...
3. Le côté client complétera l’échange de code avec Auth0 et récupérera le `id_token` et le `access_token` de l’utilisateur, qui seront sauvegardés dans la mémoire.
   ...
   <Frame>![Diagramme de stockage en mémoire des meilleures pratiques de stockage de jetons](//images.ctfassets.net/cdy7uua7fh8z/6a4aA0TH8PJQpvhkLaGSIp/a60fc14a74bdb12274c2619d5c7c0f22/in-memory-token-storage.png)</Frame>
...
* [Guides de démarrage rapide pour applications Web classiques](/docs/quickstart/webapp)
...
* [Native/Mobile Apps Quickstarts (Démarrages rapides d’applications natives/mobiles)](/docs/quickstart/native)
...
En conformité avec les spécifications OAuth2, lorsqu’un navigateur demande un jeton d’actualisation à partir du point de terminaison /token, Auth0 ne renverra un jeton d’actualisation que si la [Rotation des jetons d’actualisation](/docs/secure/tokens/refresh-tokens/refresh-token-rotation) est activée pour ce client.
