...
Une façon de vérifier les demandes envoyées est d’utiliser le [paramètre d’état](/docs/fr-ca/secure/attack-protection/state-parameters) du protocole <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">OAuth</Tooltip> 2.0pour authentifier la réponse.
