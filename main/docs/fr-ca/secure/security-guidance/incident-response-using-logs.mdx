...
La page [Syntaxe de requête de recherche de journaux](/docs/deploy-monitor/logs/log-search-query-syntax) fournit des détails sur la syntaxe des requêtes de journal d’Auth0 et inclut d’autres exemples de requêtes.
...
* Rechercher pour des appels de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip> récents : `type : « sapi »`
