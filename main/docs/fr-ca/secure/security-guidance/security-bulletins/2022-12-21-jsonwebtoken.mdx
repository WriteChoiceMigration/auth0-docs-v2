...
* Un algorithme par défaut non sécurisé dans <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">jwt</Tooltip>.verify() pourrait entraîner un contournement de la validation de la signature : [CVE-2022-23540](https://github.com/auth0/node-jsonwebtoken/security/advisories/GHSA-qwph-4952-7xr6)
