...
* Du code de règle personnalisée, contenant une logique conditionnelle pour appliquer l’authentification multifacteur (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip>), menace la bonne application de la MFA, en particulier en mode d’authentification silencieuse.
