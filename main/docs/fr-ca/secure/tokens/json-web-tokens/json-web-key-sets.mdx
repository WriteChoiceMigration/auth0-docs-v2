...
<td>Un objet JSON qui représente un ensemble de JWKs. L’objet JSON DOIT avoir un membre <code>clés</code>, qui est un tableau de JWC.</td>
</tr>
</tbody>
</table>
