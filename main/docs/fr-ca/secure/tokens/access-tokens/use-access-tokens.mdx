...
Dans cet exemple, le jeton d’accès est un jeton web JSON (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">JWT</Tooltip>) qui décode les demandes suivantes :
