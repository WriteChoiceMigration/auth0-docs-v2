...
<tbody>
<tr>
<td style="text-align:left">`client_id` <br/><span class="label label-danger">Requis</span></td>
...
<td style="text-align:left">Le secret client de votre application. Requis pour les <a href="/docs/fr-ca/applications/concepts/app-types-confidential-public#confidential-applications">applications confidentielles</a>.</td>
</tr>
<tr>
<td style="text-align:left">`token` <br/><span class="label label-danger">Required</span></td>
