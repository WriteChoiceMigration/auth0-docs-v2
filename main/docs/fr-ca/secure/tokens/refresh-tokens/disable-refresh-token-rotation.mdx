...
Vous pouvez désactiver la rotation des jetons d’actualisation de chaque application en utilisant le Dashboard ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>.
