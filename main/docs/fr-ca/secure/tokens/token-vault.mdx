...
<tr>
<td><a href="/docs/secure/tokens/token-vault/configure-refresh-token-exchange-with-token-vault">Configure Refresh Token Exchange with Token Vault</a></td>
...
<tr>
<td><a href="/docs/secure/tokens/token-vault/configure-access-token-exchange-with-token-vault">Configure Access Token Exchange with Token Vault</a></td>
