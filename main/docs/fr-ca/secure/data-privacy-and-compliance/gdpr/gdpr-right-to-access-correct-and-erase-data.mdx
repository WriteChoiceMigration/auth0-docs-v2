...
Avec Auth0, vous pouvez accéder, modifier et supprimer les informations de l'utilisateur manuellement, à l’aide du Dashboard, ou par programmation, à l’aide de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>.
...
<td>Les objets <code>app_metadata</code> et <code>user_metadata</code> sont modifiables à partir de cet écran. Modifiez le JSON dans la section <strong>Métadonnées</strong> et enregistrez vos modifications.</td>
</tr>
<tr>
