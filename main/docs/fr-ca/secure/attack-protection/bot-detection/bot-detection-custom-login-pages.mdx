...
4. Utilisez le modèle fourni pour commencer à personnaliser votre page de connexion.
   ...
   Nous vous recommandons d’utiliser un logiciel de contrôle des versions pour gérer le code source de vos pages de connexion personnalisées. Pour en savoir plus, lisez [Contrôle des versions des pages de connexion classiques](/docs/customize/login-pages/classic-login/version-control).
