...
2. Dans la section **Détection**, activez le bouton bascule.
   ...
   <Frame>![Section Détection de l’écran Protection contre les attaques](/images/fr-ca/cdy7uua7fh8z/3q0HlAm0m0aLilEOAhQ81h/a6669bf2bb063e860b80ddb9bfbabc22/Bot_Detection_-_French.png)</Frame>
...
3. Dans la section **Réponse**, choisissez une réponse à la détection de robots.
   ...
   <Frame>![Dashboard - Protection contre les attaques - Détection des robots](/images/fr-ca/cdy7uua7fh8z/3vuVvc01mfCPdc70AU9Oq1/b5d5237e0e8efc048eee5bc03b359d57/Bot_Detection_Options.png)</Frame>
...
<Frame>![Auth0 Dashboard > Security (Sécurité) > Protection contre les attaques pour accéder à ce curseur](/images/fr-ca/cdy7uua7fh8z/6HSMEXmDHVks6aUH0FUTPo/88890090e3e357a627b095c12ee06daa/Bot_Detection_Levels_-_French.png)</Frame>
...
<td>Prise en charge si vous utilisez l’une des trousses SDK suivantes :<ul><li style="font-size: .875rem;">`Auth0.swift` version 1.28.0+</li><li style="font-size: .875rem;">`Auth0.Android` version 1.25.0+</li><li style="font-size: .875rem;">`Lock.Swift` version 2.19.0+</li><li style="font-size: .875rem;">`Lock.Android` version 2.22.0+</li></ul></td>
</tr>
<tr>
