...
When your tenant or <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> receives a request, Tenant ACL processes that request and then determines how to respond based on the rules you have configured.
