...
En utilisant Bring Your Own Key (BYOK, « Utilisez votre propre clé »), les utilisateurs avec le [rôle Éditeur de gestion de clés](/docs/fr-ca/get-started/manage-dashboard-access/add-dashboard-users) peuvent utiliser le <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> pour remplacer la clé racine par défaut de l’environnement Auth0 par leur propre clé racine fournie par le client.
...
<Frame>![Dashboard > Settings > Encryption Keys](//images.ctfassets.net/cdy7uua7fh8z/1qmfCSl7cOugrHIAdxSyAt/1f05c23a58ba8d3bbc127be294e30c30/Encryption_Keys_-_FR.png)</Frame>
...
<Frame>![Dashboard > Settings > Encryption Keys > Upload](//images.ctfassets.net/cdy7uua7fh8z/1GJPgT1Be7Wm6G6ldCVW4q/96e5a326aa643f29bb50aea76fce27aa/image__2_.png)</Frame>
