...
Finally, you will need a **Native** Auth0 application. If you don’t have a Native Auth0 application already, [create one](/docs/fr-ca/get-started/auth0-overview/create-applications/native-apps) before continuing. Avoid using other application types, as they have different configurations and may cause errors.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/native/flutter/01-login.md)