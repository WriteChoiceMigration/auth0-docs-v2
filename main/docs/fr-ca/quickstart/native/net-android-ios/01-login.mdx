...
'og:title': "Add login to your .NET Android or iOS application"
'og:description': "This tutorial demonstrates how to add user login with Auth0 to a .NET Android or iOS application."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/xamarin.png"
'twitter:title': "Add login to your .NET Android or iOS application"
'twitter:description': "This tutorial demonstrates how to add user login with Auth0 to a .NET Android or iOS application."
---
...
4. [Accessing the User's Information](#accessing-the-user-s-information)
5. [Logout](#logout)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-xamarin-oidc-samples/tree/master/Quickstart/01-Login)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/native/net-android-ios/01-login.md)