...
* Configure your Auth0 application in the dashboard to use Facebook Native Sign In. See [Add Facebook Login to Native Apps](/docs/connections/nativesocial/facebook). **When you finish this step, your application will be able to implement Facebook Native Login.**
...
You can read more about Auth0 scopes in the dedicated [article](/docs/scopes/current/oidc-scopes).
...
[* Learn how to securely store tokens](/docs/libraries/auth0-android/save-and-refresh-tokens)[* Learn to call an API](/docs/quickstart/native/android/01-user-metadata)[* Configure other identity providers](/docs/identityproviders)[* Learn more about the Android SDK](/docs/libraries/auth0-android)
