...
* Configure your Auth0 application in the dashboard to use Facebook Native Sign In. See [Add Facebook Login to Native Apps](/docs/fr-ca/connections/nativesocial/facebook). **When you finish this step, your application will be able to implement Facebook Native Login.**
...
However, if you do plan to support Web Authentication, head over [here](/docs/fr-ca/libraries/auth0-android#authentication-via-universal-login) to learn how to declare the Manifest Placeholders.
...
You can read more about Auth0 scopes in the dedicated [article](/docs/fr-ca/scopes/current/oidc-scopes).
...
[* Learn how to securely store tokens](/docs/fr-ca/libraries/auth0-android/save-and-refresh-tokens)[* Learn to call an API](/docs/fr-ca/quickstart/native/android/01-user-metadata)[* Configure other identity providers](/docs/fr-ca/identityproviders)[* Learn more about the Android SDK](/docs/fr-ca/libraries/auth0-android)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/native/android-facebook-login/00-login-facebook.md)