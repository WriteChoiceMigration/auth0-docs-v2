...
Before you continue with this tutorial, make sure that you have completed the [Login chapter](/docs/fr-ca/quickstart/native/android)
...
In addition, in the case of the Auth0 Management API, the audience is `https://{yourDomain}/api/v2/`. In the case of your APIs, you create an *Identifier* value that serves as the *Audience* value whenever you [set up an API](https://auth0.com/docs/getting-started/set-up-api) with Auth0.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/native/android/01-user-metadata.md)