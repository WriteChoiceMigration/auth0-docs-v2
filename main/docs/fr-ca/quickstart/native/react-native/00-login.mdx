...
First, you must provide a way for your users to log in. We recommend using the Auth0 hosted [login page](/docs/fr-ca/hosted-pages/login).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/native/react-native/00-login.md)