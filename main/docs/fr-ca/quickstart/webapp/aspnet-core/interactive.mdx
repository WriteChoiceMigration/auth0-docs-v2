...
[##### Ajouter une fonctionnalité de connexion à votre application ASP.NET MVC](#Ajouter une fonctionnalité de connexion à votre application ASP.NET MVC)
...
5. [ASP.NET Core MVC](/docs/fr-ca/quickstart/webapp/aspnet-core/interactive)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/webapp/aspnet-core/interactive.md)
