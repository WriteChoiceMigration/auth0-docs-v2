...
'og:title': "Login"
'og:description': "This tutorial demonstrates how to add user login to an ASP.NET OWIN application."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/asp.png"
'twitter:title': "Login"
'twitter:description': "This tutorial demonstrates how to add user login to an ASP.NET OWIN application."
---
...
2. [Configure Callback URLs](#configure-callback-urls)
3. [Install and configure the OpenID Connect middleware](#install-and-configure-the-openid-connect-middleware)
4. [Add login to your ASP.NET OWIN application](#add-login-to-your-asp-net-owin-application)
5. [Add logout to your ASP.NET OWIN application](#add-logout-to-your-asp-net-owin-application)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-aspnet-owin-mvc-samples/tree/master/Quickstart/Sample)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/webapp/aspnet-owin/01-login.md)