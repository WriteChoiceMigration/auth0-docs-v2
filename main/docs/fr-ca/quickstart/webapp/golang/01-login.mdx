...
'og:title': "Login"
'og:description': "This tutorial demonstrates how to add user login to a Go web application using Auth0."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/golang.png"
'twitter:title': "Login"
'twitter:description': "This tutorial demonstrates how to add user login to a Go web application using Auth0."
---
...
2. [Configure Go to Use Auth0](#configure-go-to-use-auth0)
3. [Logging In](#logging-in)
4. [Handling Authentication Callback](#handling-authentication-callback)
5. [Displaying User Information](#displaying-user-information)
6. [Logging Out](#logging-out)
7. [Optional Steps](#optional-steps)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-golang-web-app/tree/master/01-Login)
...
For information about the userinfo hash, see [User Profile](/docs/fr-ca/users/concepts/overview-user-profile).

## Logging Out

To log the user out, clear the data from the session and redirect the user to the Auth0 logout endpoint. You can find
more information about this in the [logout documentation](/docs/fr-ca/logout).
...
The redirect URL needs to be in the list of Allowed Logout URLs in the settings section of the application, For more information, see [Redirect Users After Logout](/docs/fr-ca/logout/guides/redirect-users-after-logout).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/webapp/golang/01-login.md)