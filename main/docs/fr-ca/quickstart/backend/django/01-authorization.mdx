...
'og:description': "This tutorial demonstrates how to add authorization to a Django REST Framework API."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/django.png"
'twitter:title': "Authorization"
'twitter:description': "This tutorial demonstrates how to add authorization to a Django REST Framework API."
---
...
2. [Setup the Django Application](#setup-the-django-application)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-django-api/tree/master/01-Authorization)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/django/01-authorization.md)