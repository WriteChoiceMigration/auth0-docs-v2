...
<Frame>![Response for unauthorized API request](/docs/fr-ca/media/articles/server-apis/using/private-unauthorized.png)</Frame>
...
<Frame>![Response for authorized API request](/docs/fr-ca/media/articles/server-apis/using/private.png)</Frame>
...
<Frame>![Response for scoped API request](/docs/fr-ca/media/articles/server-apis/using/private-scoped.png)</Frame>

If the required scope is not present, the API returns a 403 HTTP Status (Forbidden):

<Frame>![Response for forbidden scoped API request](/docs/fr-ca/media/articles/server-apis/using/private-scoped-forbidden.png)</Frame>
