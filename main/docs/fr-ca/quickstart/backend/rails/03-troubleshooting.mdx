...
<Frame>![Debugging a JWT on JWT.io](/docs/fr-ca/media/articles/server-apis/aspnet-core-webapi/jwt-io-debugger-rs256.png)</Frame>
...
<Frame>![Debugging a JWT on JWT.io](/docs/fr-ca/media/articles/server-apis/aspnet-core-webapi/jwt-io-debugger-hs256.png)</Frame>
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/rails/03-troubleshooting.md)