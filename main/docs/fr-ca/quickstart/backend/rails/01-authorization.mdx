...
'og:description': "This tutorial demonstrates how to add authorization to a Ruby on Rails API."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/rails.png"
'twitter:title': "Authorization"
'twitter:description': "This tutorial demonstrates how to add authorization to a Ruby on Rails API."
---

# Ruby On Rails API: Authorization

<Frame>![Gravatar for josh.cunningham@auth0.com](//www.gravatar.com/avatar/ae098a33ae2acd0fd647f48749f8630c?d=mm&r=g&s=50)</Frame>
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-rubyonrails-api-samples/tree/master/01-Authentication-RS256)
...
We recommend using the default RS256 [signing algorithm](/docs/fr-ca/tokens/concepts/signing-algorithms) for your API. If you need to use the HS256 algorithm, see the [HS256 integration sample](https://github.com/auth0-samples/auth0-rubyonrails-api-samples/tree/OIDC/02-Authentication-HS256).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/rails/01-authorization.md)