...
'og:description': "This tutorial demonstrates how to add authorization to an Express.js API."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/node.png"
'twitter:title': "Authorization"
'twitter:description': "This tutorial demonstrates how to add authorization to an Express.js API."
---
...
We recommend using the default RS256 [signing algorithm](/docs/fr-ca/tokens/concepts/signing-algorithms) for your API. If you need to use the HS256 algorithm, see the [HS256 integration sample](https://github.com/auth0-samples/auth0-express-api-samples/tree/master/02-Authorization-HS256).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/nodejs/01-authorization.md)