...
'og:description': "This tutorial demonstrates how to add authorization to an ASP.NET Core Web API application using the standard JWT middleware."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/asp.png"
'twitter:title': "Authorization"
'twitter:description': "This tutorial demonstrates how to add authorization to an ASP.NET Core Web API application using the standard JWT middleware."
---
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-aspnetcore-webapi-samples/tree/master/Quickstart/01-Authorization)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/aspnet-core-webapi/01-authorization.md)