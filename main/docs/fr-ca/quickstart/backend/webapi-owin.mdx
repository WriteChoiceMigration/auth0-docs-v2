...
<Frame>![Create API](/docs/fr-ca/media/articles/server-apis/create-api.png)</Frame>
...
<Frame>![Configure Permissions](/docs/fr-ca/media/articles/server-apis/configure-permissions.png)</Frame>
