...
'og:description': "This guide demonstrates how to integrate Auth0 with a PHP backend API using the Auth0 PHP SDK."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/php.png"
'twitter:title': "Authorization"
'twitter:description': "This guide demonstrates how to integrate Auth0 with a PHP backend API using the Auth0 PHP SDK."
---
...
2. [Integrating your PHP Backend API](#integrating-your-php-backend-api)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-php-api-samples/tree/main/app)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/php/01-authorization.md)