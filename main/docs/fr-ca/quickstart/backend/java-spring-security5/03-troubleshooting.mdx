...
'og:description': "This document will help you troubleshoot your configuration if you get unexpected responses from your API."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/java.png"
'twitter:title': "Troubleshooting"
'twitter:description': "This document will help you troubleshoot your configuration if you get unexpected responses from your API."
---

# Spring Boot API: Troubleshooting
...
[* Configure other identity providers](/docs/fr-ca/identityproviders)[* Enable multifactor authentication](/docs/fr-ca/multifactor-authentication)[* Learn about attack protection](/docs/fr-ca/attack-protection)[* Learn about Role-Based Access Control](/docs/fr-ca/authorization/concepts/rbac)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/java-spring-security5/03-troubleshooting.md)