...
'og:description': "This tutorial demonstrates how to add authorization to an API using the Okta Spring Boot Starter."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/java.png"
'twitter:title': "Authorization"
'twitter:description': "This tutorial demonstrates how to add authorization to an API using the Okta Spring Boot Starter."
---
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-spring-security5-api-sample/tree/master/01-Authorization-MVC)
...
* How to check if the token is valid, using the [JSON Web Key Set (JWKS)](/docs/fr-ca/tokens/concepts/jwks) for your Auth0 account. To learn more about validating Access Tokens, see [Validate Access Tokens](/docs/fr-ca/tokens/guides/validate-access-tokens).

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">

**New to Auth0?** Learn [how Auth0 works](/docs/fr-ca/overview) and read about [implementing API authentication and authorization](/docs/fr-ca/api-auth)  using the OAuth 2.0 framework.
...
<tbody>
<tr>
<td>`okta.oauth2.audience`</td>
<td>The unique identifier for your API. If you are following the steps in this tutorial it would be `https://quickstarts/api`.</td>
</tr>
<tr>
<td>`okta.oauth2.issuer`</td>
<td>The issuer URI of the resource server, which will be the value of the `iss` claim in the JWT issued by Auth0. Spring Security will use this property to discover the authorization server's public keys and validate the JWT signature. The value will be your Auth0 domain with an `https://` prefix and a `/` suffix (the trailing slash is important).</td>
</tr>
</tbody>
</table>
...
The sample application will be available at `http://localhost:3010/`. Read about how to test and use your API in the [Using Your API](/docs/fr-ca/quickstart/backend/java-spring-security5/02-using) article.

##### What can you do next?

[* Part 2: Using Your API](/docs/fr-ca/quickstart/backend/java-spring-security5/02-using)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/backend/java-spring-security5/01-authorization.md)