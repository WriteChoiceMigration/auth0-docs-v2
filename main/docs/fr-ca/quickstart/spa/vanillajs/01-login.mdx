...
[Universal Login](/docs/fr-ca/hosted-pages/login) is the easiest way to set up authentication in your application. We recommend using it for the best experience, best security and the fullest array of features. This guide will use it to provide a way for your users to log in to your JavaScript application.

<Note>

You can also embed the login dialog directly in your application using the [Lock widget](/docs/fr-ca/lock). If you use this method, some features, such as single sign-on, will not be accessible.

</Note>

When a user logs in, Auth0 returns three items:

* `access_token`: to learn more, see the [Access Token documentation](/docs/fr-ca/tokens/concepts/access-tokens)
* `id_token`: to learn more, see the [ID Token documentation](/docs/fr-ca/tokens/concepts/id-tokens)
...
[* Part 2: Calling an API using an access token](/docs/fr-ca/quickstart/spa/vanillajs/02-calling-an-api)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/spa/vanillajs/01-login.md)