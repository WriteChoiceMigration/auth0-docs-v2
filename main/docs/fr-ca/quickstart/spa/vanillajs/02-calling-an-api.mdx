...
'og:description': "This tutorial demonstrates how to make API calls for protected resources on your server."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/html5.png"
'twitter:title': "Calling an API"
'twitter:description': "This tutorial demonstrates how to make API calls for protected resources on your server."
---
...
2. [Create a Backend API](#create-a-backend-api)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-javascript-samples/tree/master/02-Calling-an-API)

Most single-page apps use resources from data APIs. You may want to restrict access to those resources, so that only authenticated users with sufficient privileges can access them. Auth0 lets you manage access to these resources using [API Authorization](/docs/fr-ca/api-auth).

This tutorial shows you how to access protected resources in your API.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">

This tutorial does not show you how to add protection to your API. Read the [Backend/API quickstart documentation](/docs/fr-ca/quickstart/backend) for instructions on how to protect your API.
...
The values for `domain` and `clientId` should have already been specified as part of the [Login tutorial](/docs/fr-ca/quickstarts/spa/vanillajs/01-login). They should point to the Domain and Client ID values for your Auth0 app respectively.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/spa/vanillajs/02-calling-an-api.md)