...
'og:title': "Login"
'og:description': "This quickstart demonstrates how to add user login to a Vue.JS application using Auth0."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/vue.png"
'twitter:title': "Login"
'twitter:description': "This quickstart demonstrates how to add user login to a Vue.JS application using Auth0."
---
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-vue-samples/tree/master/01-Login)
...
[* Part 2: Calling an API using an access token](/docs/fr-ca/quickstart/spa/vuejs/02-calling-an-api)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/spa/vuejs/01-login.md)