...
[* Part 2: Calling an API using an access token](/docs/fr-ca/quickstart/spa/react/02-calling-an-api)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/fr-ca/articles/quickstart/spa/react/01-login.md)