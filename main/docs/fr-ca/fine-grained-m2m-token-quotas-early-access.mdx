---
title: "Fine-Grained Machine-to-Machine Token Quotas"
permalink: "fine-grained-m2m-token-quotas-early-access"
'og:title': "Fine-Grained Machine-to-Machine Token Quotas"
'og:description': "Learn how to use fine-grained M2M token quotas for the applications and organizations associated with your tenant."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/img/share-image.png"
'twitter:title': "Fine-Grained Machine-to-Machine Token Quotas"
'twitter:description': "Learn how to use fine-grained M2M token quotas for the applications and organizations associated with your tenant."
---
# Fine-Grained Machine-to-Machine Token Quotas

<Warning>

Fine-grained M2M token quotas are currently in Early Access. By using this feature, you agree to the applicable Free Trial terms in Okta’s [Master Subscription Agreement](https://www.okta.com/legal). Reach out to your Auth0 contact to request access. To learn more about Auth0's product release cycle, read [Product release stages](/docs/troubleshoot/product-lifecycle/product-release-stages).

</Warning>

The [Client Credentials Flow](/docs/get-started/authentication-and-authorization-flow/client-credentials-flow) enables Machine-to-Machine (M2M) applications, such as CLIs, daemons, or backend services, to obtain <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">access tokens</Tooltip> on their own behalf without any user interaction.
