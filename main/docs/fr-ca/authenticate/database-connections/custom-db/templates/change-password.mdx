...
---
# Modifier les modèles de script de mot de passe
...
<td>Objet</td>
<td>Facultatif</td>
<td>Indique que l’opération de modification du mot de passe a réussi. Si la propriété <code>last_password_reset</code> est présente, elle sera mise à jour dans le profil de l’utilisateur.</td>
</tr>
</tbody>
</table>
