...
<td>Booléen</td>
<td>Facultatif</td>
<td>Contient des valeurs qui représentent le statut de vérification de l’utilisateur dans la base de données externe (<code>true</code> ou <code>false</code>). Requis uniquement si la valeur est <code>true</code>.</td>
</tr>
</tbody>
</table>
