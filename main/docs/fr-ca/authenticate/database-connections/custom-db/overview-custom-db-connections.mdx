...
1. Utilisez le point de terminaison [Créer des connexions](/docs/api/management/v2#!/Connections/post_connections) avec la stratégie `auth0`.
...
<Frame>![Anatomie des connexions à des bases de données personnalisées](//images.ctfassets.net/cdy7uua7fh8z/2lHqvZKFiEbAXURU2gmchc/9fbe6735945886d3ee50968e0d30d1b1/custom-database-connections.png)</Frame>
