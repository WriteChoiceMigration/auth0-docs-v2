...
<Frame>![Passwordless email workflow diagram with embedded login](//images.ctfassets.net/cdy7uua7fh8z/3HMLxPTq9eCsq1eR21s0bL/ad401ee9fbe0716250d49ea04993a056/SMS_Email_Flow_Updated.png)</Frame>

### Connexion universelle d’Auth0

<Frame>![Passwordless email workflow diagram with universal login](//images.ctfassets.net/cdy7uua7fh8z/5p3cKrJwmc7MxpQ7pbXsjC/285f3b54caba8a05075b6a0036990aaa/Screenshot_2024-10-29_at_11.54.03.png)</Frame>
...
Pour plus d’informations sur ces paramètres et leurs valeurs, lisez le point de terminaison [Get organization](https://auth0.com/docs/api/management/v2#!/Organizations/get_organizations_by_id) (obtenir une organisation) de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> Auth0.
