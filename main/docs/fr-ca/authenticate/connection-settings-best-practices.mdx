...
Configurez toutes les connexions <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">SAML</Tooltip> pour signer les demandes et utilisez RSA-SHA256 comme algorithme de signature. Cela garantit que le fournisseur d’identité SAML distant peut vérifier si les demandes d’authentification proviennent d’une application légitime ou non.