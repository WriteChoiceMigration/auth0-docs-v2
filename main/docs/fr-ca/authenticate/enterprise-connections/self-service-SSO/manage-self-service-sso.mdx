...
1. Récupérez l’identifiant du profil de libre-service que vous souhaitez associer au ticket d’accès à partir du point de terminaison [Récupérer les profils de libre-service](/docs/fr-ca/api/management/v2/self-service-profiles/get-self-service-profiles).
...
* [Accéder à un profil en libre-service par identifiant](/docs/fr-ca/api/management/v2/self-service-profiles/get-self-service-profiles-by-id)
* [Supprimer un profil en libre-service par identifiant](/docs/fr-ca/api/management/v2/self-service-profiles/delete-self-service-profiles-by-id)
