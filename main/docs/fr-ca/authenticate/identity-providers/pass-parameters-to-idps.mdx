...
---
# Transmettre les paramètres aux fournisseurs d’identité

Vous pouvez passer des paramètres propres au fournisseur à un fournisseur d’identité (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip>) lors de l’authentification. Les valeurs peuvent être statiques par connexion ou dynamiques par utilisateur.
...
* Les fournisseur d’identité (IdP) <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">SAML</Tooltip> ne prennent pas en charge les paramètres en amont.
...
WordPress vous permet de passer un paramètre `blog` facultatif à son point de terminaison d’autorisation <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">OAuth</Tooltip> 2.0, et de demander automatiquement l’accès à un blog précis pour les utilisateurs lorsqu’ils se connectent. Pour en savoir plus, veuillez consulter la [documentation Oauth 2.0 de WordPress](https://developer.wordpress.com/docs/oauth2/).
...
Appeler le point de terminaison [Get a connection (Obtenir une connexion)](/docs/api/management/v2#!/Connections/get_connections_by_id) de Management API pour récupérer les valeurs existantes de l’objet `options` :
...
```
```java java.java
HttpResponse response = Unirest.get("https://{yourDomain}/api/v2/connections/%7ByourWordpressConnectionId%7D")
.header("authorization", "Bearer {yourMgmtApiAccessToken}")
.header("content-type", "application/json")
.asString();
```
...
```
```java java.java
HttpResponse response = Unirest.patch("https://{yourDomain}/api/v2/connections/%7ByourWordpressConnectionId%7D")
.header("authorization", "Bearer {yourMgmtApiAccessToken}")
.header("content-type", "application/json")
...
```
```java java.java
HttpResponse response = Unirest.get("https://{yourDomain}/api/v2/connections/%7ByourXConnectionId%7D")
.header("authorization", "Bearer {yourMgmtApiAccessToken}")
.header("content-type", "application/json")
.asString();
```
...
```
```java java.java
HttpResponse response = Unirest.patch("https://{yourDomain}/api/v2/connections/%7ByourXConnectionId%7D")
.header("authorization", "Bearer {yourMgmtApiAccessToken}")
.header("content-type", "application/json")
