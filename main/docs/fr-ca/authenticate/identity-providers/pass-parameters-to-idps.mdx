...
Appeler le point de terminaison [Get a connection (Obtenir une connexion)](/docs/fr-ca/api/management/v2#!/Connections/get_connections_by_id) de Management API pour récupérer les valeurs existantes de l’objet `options` :
