...
<Frame>![Consent screen](//images.ctfassets.net/cdy7uua7fh8z/5YcLIDCt3RaAkmK1cTeCJL/e85e16195e84aa52f7675faacd126853/consent-screen.png)</Frame>
...
5. `prompt=none` ne fonctionnera pas sur le point de terminaison [/authorize](/docs/api/authentication/reference#social). La méthode checkSession() [Auth0.js](/docs/fr-ca/libraries/auth0js) utilise `prompt=none` en interne, donc cela ne fonctionnera pas non plus.
