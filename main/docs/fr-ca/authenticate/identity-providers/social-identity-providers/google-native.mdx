...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/6WofMhOOH7GU0NwEcyebiZ/4d4adcb20b74215c7026c1bc9c95be6c/Google_Sign_In_diagram.png)</Frame>
...
To update your application through the Management API, call the [Update a client](/docs/api/management/v2/clients/patch-clients-by-id) endpoint as follows:
