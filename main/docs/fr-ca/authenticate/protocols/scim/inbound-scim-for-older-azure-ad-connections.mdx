...
7. Allez dans **Mappages**et sélectionnez **Fourniture des utilisateurs Microsoft Entra ID,** puis trouvez **Fourniture des utilisateurs Microsoft Entra ID**et désélectionnez **Créer** sous **Actions de l’objet cible.**
   ...
   <Frame>![Azure AD Mappings for Inbound SCIM ](/images/fr-ca/cdy7uua7fh8z/3ndwqpnyZvhWYSn2nvM2Qj/19e568c435d90aa8a294140f482b2257/azureadmappings.jpg)</Frame>
...
11. Sur l’écran **Modifier l’attribut**, définissez **Correspondance des objets utilisant cet attribut** à **Oui**, puisdéfinissez **Priorité de correspondance** à **2**et cliquez sur **OK.**
    ...
    <Frame>![Edit Attribute in Azure AD for Inbound SCIM ](/images/fr-ca/cdy7uua7fh8z/7EbSKlTnXlpQdqw6R5blBJ/01999edb569825e07004e0c2eb11508b/editattribute.jpg)</Frame>

12. Choisissez **Enregistrer** pour enregistrer les mappages d’attributs. L’écran suivant s’affiche :

    <Frame>![Attribute Mapping on Azure for Inbound SCIM](/images/fr-ca/cdy7uua7fh8z/2xCmuXkW7GGF8n3C84jOwI/3e70b7ab835d8dd73b36fdffbc3f5eb6/Attributemapping.jpg)</Frame>
