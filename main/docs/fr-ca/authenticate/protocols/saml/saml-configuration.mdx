...
Les applications, en particulier les applications personnalisées, peuvent authentifier les utilisateurs par rapport à un <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip> externe à l’aide de protocoles comme <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">OpenID</Tooltip> Connect (OIDC) ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">OAuth 2.0</Tooltip>. Toutefois, il se peut que vous souhaitiez utiliser un fournisseur <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-3" tip="">SAML</Tooltip> d’entreprise pour l’authentification, même si votre application a été conçue pour utiliser l’un des deux protocoles.

<Frame>![Protocoles SAML SP Schéma](//images.ctfassets.net/cdy7uua7fh8z/F29Tn5sjo1hqHSxslyHhR/69b3d2d4dd22389de1d20255e4aa3c5f/saml-case1.png)</Frame>
...
<Frame>![Protocoles Diagramme IdP SAML](//images.ctfassets.net/cdy7uua7fh8z/2fREft2nQOfBNh1cZfgsZH/f0603d099e210e4f06acc1646365756b/saml-case2.png)</Frame>
...
* ADFS
* Dot Net Workflow
* Elastic <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">SSO</Tooltip> Team & Enterprise
...
* En utilisant le <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-5" tip="">Auth0 Dashboard</Tooltip>.
* En appelant l’Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-6" tip="">Management API</Tooltip>.
...
<Frame>![Protocoles Auth0 comme SP et IdP SAML Schéma](//images.ctfassets.net/cdy7uua7fh8z/7Ds9dLC3HaxGBLsG3ry7B9/ad7de744d2d4074b3263b3c9872c5e49/saml-case3.png)</Frame>
