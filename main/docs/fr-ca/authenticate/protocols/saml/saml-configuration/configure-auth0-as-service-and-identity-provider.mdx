...
Vous pouvez configurer Auth0 en tant que fournisseur de services (SP) et fournisseur d’identité (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip>) pour tester votre connexion d’authentification unique <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">SAML</Tooltip> (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">SSO</Tooltip>).
...
1. Allez dans l’[Auth0 Dashboard](https://manage.auth0.com/#/), sélectionnez votre nom de locataire et sélectionnez **Créer un locataire**.
   ...
   <Frame>![Dashboard (Tableau de bord) - Tenant (Locataire) - Menu déroulant - Créer un locataire](//images.ctfassets.net/cdy7uua7fh8z/53KetqhNIGDs6N5cqJdQtz/dda47c7d1aa9172bf690d6f4e5d17617/2025-02-26_14-49-48.png)</Frame>
...
<td>Entrez un nom, comme <code>SAML-Auth0-IDP</code>.</td>
</tr>
<tr>
...
<td>Cliquez sur la touche rouge <strong>TÉLÉVERSEZ VOTRE CERTIFICAT...</strong> et sélectionnez le fichier<code>.pem</code> que vous avez téléchargé ci-dessus.</td>
</tr>
</tbody>
</table>
