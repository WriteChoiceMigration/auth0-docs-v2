...
Configurez SiteMinder en tant que fournisseur d’identité <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">SAML</Tooltip> en procédant comme suit.
