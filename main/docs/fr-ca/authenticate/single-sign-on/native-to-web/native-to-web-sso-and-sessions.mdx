...
Native to Web SSSO does not change standard Auth0 [Single Sign-On](/docs/fr-ca/authenticate/single-sign-on) authentication.

</Callout>

**Specific Native to Web <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">SSO</Tooltip> flows can result in the following behaviors:**
