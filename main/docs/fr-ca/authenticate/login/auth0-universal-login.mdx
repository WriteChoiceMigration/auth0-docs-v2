...
<Frame>![In Early Access, this toggle enables WCAG elements in your sign-in flow. ](//images.ctfassets.net/cdy7uua7fh8z/5O4DDy1h0rgbYNzKwm1lKY/e3c5ec0d81c8814b802f2ca64b4a2619/WCAG_-_FR.png)</Frame>

Vous pouvez également activer cette fonctionnalité dans Management API en mettant à jour l’indicateur `enable_ulp_wcag_compliance` dans le [point de terminaison Mise à jour des paramètres de l’invite](/docs/api/management/v2/prompts/patch-prompts) :
...
Vous pouvez appeler directement le [point de terminaison de la connexion](/docs/api/authentication#login) à partir de n’importe quel navigateur.
...
Pour plus d’informations sur la façon de configurer la Connexion universelle pour votre application, consultez les [Guides de démarrage rapide](/docs/quickstarts). Choisissez l’approche qui correspond le mieux à vos technologies et suivez le guide de démarrage rapide pour un aperçu de la mise en œuvre.
