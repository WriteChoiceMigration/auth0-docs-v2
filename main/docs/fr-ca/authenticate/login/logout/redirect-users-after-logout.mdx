...
2. Ajoutez l’URL `returnTo` non codée (par exemple, `https://www.example.com`) dans la liste des **URL de déconnexion autorisées** à l’un des deux endroits suivants :
   ...
   * **Paramètres du locataire** : Pour les demandes de déconnexion qui n’incluent pas le paramètre `client_id`, vous devez ajouter l’URL `returnTo` à la liste **URL de déconnexion autorisées** dans l’onglet [Avancé de vos Paramètres de locataire](https://manage.auth0.com/#/tenant/advanced).
     ...
     <Frame>![Auth0 Dashboard (Tableau de bord Auth0) Paramètres Avancé Onglet Connexion et Déconnexion](//images.ctfassets.net/cdy7uua7fh8z/77s6AWMuzH78ABObR3lg0o/d8fa6804852065de531aef6f8e04fde5/2025-02-27_11-13-53.png)</Frame>
