...
Vous pouvez déconnecter un utilisateur de la session Auth0 et (le cas échéant) de la session du fournisseur d’identité (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip>). Lorsque vous mettez en œuvre la fonctionnalité de déconnexion, il y a généralement trois couches de session à prendre en compte.
