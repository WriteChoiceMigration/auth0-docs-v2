...
* Doit utiliser le point de terminaison [`/oauth/token`](/docs/api/authentication#refresh-token) pour obtenir de nouveaux jetons car le point de terminaison [`/delegation`](/docs/api/authentication#delegation) est déconseillé.
