...
Pour les connexions aux bases de données, Auth0 limite le nombre de tentatives de connexion répétées par utilisateur et par adresse IP. Pour en savoir plus, consultez [Limites de taux d’authentification par utilisateur/mot de passe](/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy/database-connections-rate-limits).
...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/3SNKwx0KzkUwbodqUQbtvW/da031614e3b9cedfa2fc80b6d371d0c2/2025-02-20_16-48-51.png)</Frame>
