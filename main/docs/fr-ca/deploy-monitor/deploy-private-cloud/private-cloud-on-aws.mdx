...
Pour plus d’informations sur les tests de charge dans Nuage privé, voir [Limites des demandes d’environnement (Nuage privé seulement)](/docs/troubleshoot/customer-support/operational-policies/rate-limit-policy#environment-request-limits-private-cloud-only-).
