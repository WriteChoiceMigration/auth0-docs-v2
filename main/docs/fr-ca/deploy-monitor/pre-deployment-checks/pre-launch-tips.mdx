...
* Assurez-vous que les <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IDP</Tooltip> distants utilisent le protocole NTP afin que l’heure soit correctement synchronisée.
