...
Ces paramètres sont configurés sur le locataire; vous pouvez les configurer à l’aide de [Auth0 Dashboard](/docs/fr-ca/manage-users/sessions/configure-session-lifetime-settings) ou de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>.
