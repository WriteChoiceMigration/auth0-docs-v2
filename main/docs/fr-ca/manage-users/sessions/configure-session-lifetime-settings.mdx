...
---
# Configuration des paramètres de durée de vie des sessions

**Expiration absolue** L’expiration absolue d’une session est définie lors de la création de la session. Vous pouvez ajuster l’Expiration absolue en configurant les paramètres de session à l’aide du <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> ou de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip>.
...
<td><a href="https://auth0.com/docs/api/management/v2/tokens">Jeton d’accès à Management API</a> avec la permission <code>update:tenant_settings</code>.</td>
</tr>
<tr>
