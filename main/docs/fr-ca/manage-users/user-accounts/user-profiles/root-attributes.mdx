...
* Définir les attributs racine [lors de l’inscription de l’utilisateur](/docs/fr-ca/api/management/guides/users/set-root-attributes-user-signup) (via <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip> ou une inscription publique) ou [lors de l’importation](/docs/fr-ca/api/management/guides/users/set-root-attributes-user-import)
