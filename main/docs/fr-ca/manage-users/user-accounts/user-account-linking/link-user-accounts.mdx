...
## Bibliothèque Auth0.js Vous pouvez utiliser la bibliothèque [Auth0.js](/docs/fr-ca/libraries/auth0js).
...
Pour en savoir davantage, lisez [Auth0.js > User management](/docs/fr-ca/libraries/auth0js/v9#user-management).
