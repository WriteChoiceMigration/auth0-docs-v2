...
Pour dissocier des comptes, appelez Management API [Dissocier un point de terminaison de compte utilisateur](/docs/fr-ca/api/v2#!/Users/delete_user_identity_by_user_id) en utilisant le <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">JWT</Tooltip> du compte principal pour l’autorisation :
