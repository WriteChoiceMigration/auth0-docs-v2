...
Utilisez le point de terminaison [Unlink a User Account (Dissocier un compte utilisateur)](/docs/api/management/v2#!/Users/delete_user_identity_by_user_id) de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> Auth0 ou la bibliothèque Auth0.js pour dissocier une identité du compte utilisateur cible, le transformant ainsi en un compte utilisateur distinct.
...
<td><code>string</code></td>
<td>Nom du fournisseur d’identité du compte secondaire lié (par exemple, <code>google-oauth2</code>)</td>
</tr>
<tr>
<td><code>user_id</code></td>
<td><code>string</code></td>
<td>Identifiant du compte secondaire lié (par exemple, la partie <code>123456789081523216417</code> après le <code>|</code> in <code>google-oauth2|123456789081523216417</code>)</td>
</tr>
</tbody>
</table>
...
Pour dissocier des comptes, appelez Management API [Dissocier un point de terminaison de compte utilisateur](/docs/api/v2#!/Users/delete_user_identity_by_user_id) en utilisant le <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">JWT</Tooltip> du compte principal pour l’autorisation :
...
Si vous devez dissocier deux ou plusieurs comptes utilisateur, appelez Management API [Dissocier un point de terminaison de compte utilisateur](/docs/api/v2#!/Users/delete_user_identity_by_user_id) en utilisant un [Jeton d’accès à Management API](/docs/api/v2/tokens) avec la permission `update:users`.
...
1. Appelez [Dissocier un point de terminaison de compte utilisateur](/docs/api/v2#!/Users/delete_user_identity_by_user_id) de Management API v2 en utilisant [Jeton d’accès à Management API](/docs/api/v2/tokens) avec la permission `update:users`.
