...
<td>booléen</td>
<td>La valeur <code>true/false</code> (« vrai/faux ») indique si le numéro de téléphone de l’utilisateur a été vérifié. Valide uniquement pour les utilisateurs disposant d’un appareil compatible SMS.</td>
</tr>
<tr>
<td><code>logins_count</code></td>
<td>entier</td>
<td>Le nombre de fois où l’utilisateur s’est connecté. Si un utilisateur est bloqué et se connecte, la session bloquée est comptabilisée dans <code>logins_count</code> et met à jour la valeur <code>last_login</code>.</td>
</tr>
<tr>
...
<td>booléen</td>
<td>La valeur <code>true</code> (vrai) ou <code>false</code> (faux) indique si l’utilisateur a été bloqué. Remarque : <code>true</code>   rapporte <em>seulement</em> les utilisateurs bloqués via le tableau de bord de l’administrateur et Management API; il ne rapporte pas les utilisateurs bloqués par la détection d’anomalie par force brute.</td>
</tr>
<tr>
