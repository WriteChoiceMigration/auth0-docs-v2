...
3. Choisissez une applicationpour passer en revue les API autorisées répertoriées pour cette application.

<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/5FVJzuu5yq8IHwpQKdYYU6/4f596be1a92877270cb2c79460c07990/Orgs_-_Acme_M2M.png)</Frame>

</Tab><Tab title="Management API">

Les autorisations des clients associées à une organisation peuvent être récupérées via le point de terminaison [Autorisations client pour l’organisation](/docs/api/management/v2/organizations/get-organization-client-grants) de l’API :
...
Sinon, si vous souhaitez obtenir des informations sur les applications qui peuvent accéder à au moins une des API d’une organisation, vous pouvez utiliser le paramètre de requête `q` du point de terminaison [Obtenir les clients](/docs/api/management/v2/clients/get-clients) de l’API avec le terme de recherche `client_grant.organization_id:{organization_id}`. Utilisez la syntaxe Lucene, qui est similaire à la [Syntaxe de requête de recherche d’utilisateur](/docs/manage-users/user-search/user-search-query-syntax).
...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/4H3VjVTz0ZGDvV5za9y33m/21ffc94b0fcd383e2c0385ca10a79800/Organizations_-_M2M_tab.png)</Frame>
...
<tbody>
<tr>
<td><code>client_grant.organization_id:{organization_id}</code></td>
<td>Permet de rechercher des applications pouvant accéder à au moins une des API d’une organisation.</td>
</tr>
<tr>
<td><code>client_grant.allow_any_organization:true</code></td>
<td>Permet de rechercher des applications pouvant accéder à au moins une des API d’une organisation.</td>
</tr>
</tbody>
</table>
