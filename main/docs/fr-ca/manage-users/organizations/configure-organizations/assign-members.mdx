...
Pour gérer les membres directement, vous pouvez utiliser le <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> (Tableau de bord Auth0) ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip>.
...
<td><a href="/docs/tokens/management-api-access-tokens">Jetons d’accès pour Management API</a> avec la permission <code>create:organization_members</code>.</td>
</tr>
<tr>
...
<td>Permission insuffisante; permission attendue : <code>create:organization_members</code>.</td>
