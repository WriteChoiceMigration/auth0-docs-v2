...
<td><a href="/docs/tokens/management-api-access-tokens">Jeton d’accès pour Management API</a> avec la permission <code>delete:organization_members</code>.</td>
</tr>
<tr>
...
<td>Permission insuffisante; permission attendue : <code>delete:organization_members</code>.</td>
