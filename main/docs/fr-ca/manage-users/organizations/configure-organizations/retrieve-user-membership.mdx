...
'description': "Découvrez comment récupérer l’appartenance d’un utilisateur à une organisation à l’aide de Management API Auth0."
...
<td>Permission insuffisante; l’un des éléments suivants attendu : `read:organizations`.</td>
