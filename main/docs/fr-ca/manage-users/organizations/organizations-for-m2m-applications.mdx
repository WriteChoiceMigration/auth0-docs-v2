...
Pour étendre chaque requête à une organisation donnée, incluez la demande `org_id` correspondante aux jetons de communication entre machines. Les serveurs API doivent prendre en compte cette demande et l’appliquer lorsqu’ils autorisent l’accès aux ressources et aux données des API. Pour en savoir plus, consultez l’article [Travailler avec des jetons et Organizations](/docs/manage-users/organizations/using-tokens).
...
<tbody>
<tr>
<td><a href="/docs/manage-users/organizations/organizations-for-m2m-applications/configure-your-application-for-m2m-access">Configurer votre application pour l’accès M2M</a></td>
...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/6LksrBOcNzo2RXI3Tp6mCo/68f23a60fc0e3a50ceaea8e6e0bbdd8c/image4.png)</Frame>
...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/5bMEPlmTLGgBn8fq5Fp59S/62b73352d8c23e979994ee24266357c5/image7.png)</Frame>
