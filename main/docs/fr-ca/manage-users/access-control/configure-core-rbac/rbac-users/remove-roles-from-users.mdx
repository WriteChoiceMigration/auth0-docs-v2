...
---
# Supprimer les rôles des utilisateurs

Vous pouvez supprimer les [roles](/docs/fr-ca/manage-users/access-control/rbac) (rôles) attribués à un utilisateur en utilisant le Tableau de bord Auth0 ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>. Les rôles attribués sont utilisés avec l’ensemble de fonctionnalités API Authorization Core.
