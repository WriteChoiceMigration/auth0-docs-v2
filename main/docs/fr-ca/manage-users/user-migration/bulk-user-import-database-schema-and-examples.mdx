...
<td>booléen</td>
<td>Indique si l’utilisateur a vérifié son adresse courriel. Défini sur <code>false</code> par défaut si <code>email</code> est mis à jour par upsert, mais pas par <code>email_verified</code>.</td>
<td>Oui</td>
</tr>
<tr>
...
<td>chaîne</td>
<td>Le codage du hachage fourni. Doit être l’un des suivants : <ul><li><code>base64</code></li><li><code>hex</code></li><li><code>utf8</code></li></ul>Les variantes hexagonales majuscules et minuscules sont prises en charge, ainsi que la base64 encodé pour URL.</td>
</tr>
<tr>
<td><code>hash.digest</code></td>
<td>chaîne</td>
<td>L’algorithme utilisé pour générer le hachage HMAC. Doit être l’un des suivants : <ul><li><code>md4</code></li><li><code>md5</code></li><li><code>ripemd160</code></li><li><code>sha1</code></li><li><code>sha224</code></li><li><code>sha256</code></li><li><code>sha384</code></li><li><code>sha512</code></li><li><code>whirlpool</code></li></ul></td>
</tr>
<tr>
...
<td>chaîne</td>
<td>L’encodage de la clé. Doit être l’un des suivants : <ul><li><code>base64</code></li><li><code>hex</code></li><li><code>utf8</code></li></ul>Par défaut, <code>hash.key.encoding</code> est <code>utf8</code>.</td>
</tr>
<tr>
...
<td>chaîne</td>
<td>Le codage de la valeur de salage fournie. Doit être l’un des suivants : <ul><li><code>base64</code></li><li><code>hex</code></li><li><code>utf8</code></li></ul> Les variantes hexagonales majuscules et minuscules sont prises en charge, ainsi que la base64 encodé pour URL. Par défaut, <code>salt.encoding</code> est <code>utf8</code>.</td>
</tr>
<tr>
<td><code>salt.position</code></td>
<td>chaîne</td>
<td>La position de la valeur de salage lors du calcul du hachage. Par défaut, <code>salt.position</code> est <code>prefix</code>.</td>
</tr>
<tr>
<td><code>password.encoding</code></td>
<td>chaîne</td>
<td>Le codage du mot de passe utilisé pour générer le hachage. Doit être l’un des suivants : <ul><li><code>ascii</code></li><li><code>utf8</code></li><li><code>utf16le</code></li><li><code>ucs2</code></li><li><code>latin1</code></li><li><code>binary</code></li></ul> Lors de la connexion, le mot de passe fourni par l’utilisateur sera transcodé à partir de <code>password.encoding</code> avant d’être vérifié par rapport au hachage fourni. Par exemple, si votre hachage a été généré à partir d’une chaîne encodée <code>ucs2</code>, alors vous devriez définir : <code> "encoding": "ucs2"</code></td>
</tr>
<tr>
<td><code>keylen</code></td>
<td>entier</td>
<td>Longueur de clé souhaitée en octets pour le hachage scrypt. Doit être un nombre entier supérieur à zéro. <br/>Ce paramètre est requis lorsque <code>algorithm</code> est fixé à <code>scrypt</code>.</td>
</tr>
<tr>
<td><code>cost</code></td>
<td>entier</td>
<td>Paramètre de coût processeur/mémoire utilisé pour le hachage scrypt. Doit être une puissance de deux supérieure à un. Par défaut, <code>cost</code> est 16384.<br/>Ce paramètre n’est utilisé que lorsque <code>algorithm</code> est fixé à <code>scrypt</code>.</td>
</tr>
<tr>
<td><code>blockSize</code></td>
<td>entier</td>
<td>Paramètre de taille de bloc utilisé pour le hachage scrypt. Doit être un nombre entier positif. Par défaut, <code>blockSize</code> est 8.<br/>Ce paramètre n’est utilisé que lorsque <code>algorithm</code> est fixé à <code>scrypt</code>.</td>
</tr>
<tr>
<td><code>parallelization</code></td>
<td>entier</td>
<td>Paramètre de parallélisation utilisé pour le hachage scrypt. Doit être un nombre entier positif. Par défaut, <code>parallelization</code> est 1.<br/>Ce paramètre n’est utilisé que lorsque <code>algorithm</code> est fixé à <code>scrypt</code>.</td>
</tr>
</tbody>
</table>
...
<td>chaîne de caractères</td>
<td>Le numéro de téléphone pour l’authentification MFA par SMS. Il doit comporter un code pays et commencer par <code>+</code>, comme par exemple : <code>"+12125550001"</code></td>
</tr>
<tr>
...
<td>chaîne de caractères</td>
<td>Le secret OTP pour l’authentification MFA avec les applications d’authentification (Google Authenticator, Microsoft Authenticator, Authy, 1Password, LastPass). Doit être encodé en Base32 sans remplissage, par exemple : <code>"JBTWY3DPEHPK3PNP"</code></td>
</tr>
</tbody>
</table>
