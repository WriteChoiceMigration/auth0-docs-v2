...
---
# Configurer la migration automatique à partir de votre base de données
...
2. Sélectionnez l’aperçu **Base de données personnalisée** , puis activez **Utiliser ma propre base de données**.
   ...
   <Frame>![Auth0 Dashboard - Authentication (Authentification) Database Connection (Connexion à la base de données) Custom Database Settings (Paramètres de base de données personnalisée) Use Own Database (Utiliser sa propre base de données) Enabled (Activé)](//images.ctfassets.net/cdy7uua7fh8z/11HPAdVwJMmnWbzMVjHCJ8/a6f14297fa01b33c9d532dd4712aa430/2025-02-27_17-27-18.png)</Frame>
...
<Frame>![Dashboard Authentication Database Connection Custom Database tab Database Action Scripts](//images.ctfassets.net/cdy7uua7fh8z/4LBIvvjaABo51It4eVCmX3/4ef14765c79cc5b7ecfa3f3155caa9eb/Screen_Shot_2021-05-18_at_8.54.55_PM.png)</Frame>
...
* Il est fait appel au point de terminaison de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> [mettre à jour le courriel ou le nom d’utilisateur](/docs/api/v2#!/Users/patch_users_by_id) ou [créer un utilisateur](/docs/api/management/v2#!/Users/post_users) .
...
2. Utilisez le point de terminaison [List or Search Users (Lister ou Rechercher des utilisateurs)](/docs/api/v2#!/Users/get_users) de Management API.
...
3. Supprimez l’utilisateur avec le point de terminaison [Delete a Connection User (Supprimer un utilisateur de connexion)](/docs/api/management/v2#!/Connections/delete_users_by_email) de Management API.
