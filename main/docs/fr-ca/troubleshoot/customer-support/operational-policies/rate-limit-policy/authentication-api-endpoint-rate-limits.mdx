...
permalink: "authentication-api-endpoint-rate-limits"
...
Les clients qui utilisent l’extensibilité peuvent ajouter d’autres requêtes, non seulement à l’Authentication API, mais aussi à <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>, en fonction de la configuration de l’extensibilité.
...
La [protection contre les attaques exhaustives](/docs/secure/attack-protection/brute-force-protection) et la [limitation des adresses IP suspectes](/docs/secure/attack-protection/suspicious-ip-throttling) de Auth0 peuvent également limiter les connexions et les inscriptions, mais elles sont indépendantes des limites anti-attaques. Pour en savoir plus sur comment Auth0 détecte et gère les anomalies potentiellement malveillantes, lisez [Protection contre les attaques](/docs/fr-ca/secure/attack-protection).
