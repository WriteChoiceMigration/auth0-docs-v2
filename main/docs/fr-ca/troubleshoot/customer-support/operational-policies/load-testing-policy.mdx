...
Pour les clients Nuage privé, veuillez consulter la [Politique de test de charge Nuage privé](/docs/deploy/private-cloud/private-cloud-operations#load-testing).
