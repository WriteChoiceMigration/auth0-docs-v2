...
* Obtenez le jeton d’accès à partir d’un [fichier HAR](/docs/fr-ca/troubleshoot/troubleshooting-tools/generate-and-analyze-har-files) et testez-le dans l’[explorateur de Auth0 Management API](/docs/api/management/v2) pour voir s’il fonctionne.
