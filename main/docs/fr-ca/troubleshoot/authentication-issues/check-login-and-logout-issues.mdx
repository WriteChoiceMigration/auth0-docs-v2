...
* Affichez les <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">JWT</Tooltip> avec [JWT.io](http://jwt.io).
* Affichez les assertions <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">SAML</Tooltip> avec [SAMLTool.io](http://samltool.io).
