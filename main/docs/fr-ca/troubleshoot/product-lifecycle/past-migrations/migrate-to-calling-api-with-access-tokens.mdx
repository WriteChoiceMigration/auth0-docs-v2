...
L’utilisation des jetons d’ID pour appeler les points de terminaison de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> est obsolète. Vous devez utiliser des jetons d’accès. La période de grâce pour cette migration a commencé le **31 mars 2018**.
