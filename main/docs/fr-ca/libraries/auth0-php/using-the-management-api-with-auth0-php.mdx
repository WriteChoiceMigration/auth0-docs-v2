...
Quelle que soit la méthode utilisée, le jeton généré doit avoir la permission requise pour les opérations que votre application souhaite exécuter. Consultez la [documentation de l’API](/docs/api/management/v2) pour connaître les permissions requises pour le point de terminaison spécifique auquel vous essayez d’accéder.
...
Ce point de terminaison est documenté [ici](/docs/api/management/v2#!/Users/get_users).
...
Ce point de terminaison est documenté [ici](/docs/api/management/v2#!/Clients/get_clients).
