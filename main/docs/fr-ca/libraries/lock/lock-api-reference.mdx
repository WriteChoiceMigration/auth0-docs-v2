...
* `socialOrPhoneNumber ready`: émis lorsque l’écran <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Passwordless</Tooltip> avec Social + Phone Number est affiché.
