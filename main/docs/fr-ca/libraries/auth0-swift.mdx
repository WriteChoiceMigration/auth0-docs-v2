...
Assurez-vous que le paramètre [**Méthode d’authentification du point de terminaison des jetons**](/docs/get-started/applications/confidential-and-public-applications/view-application-type) est réglé sur `None`.
