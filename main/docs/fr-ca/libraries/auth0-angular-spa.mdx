...
---
# Trousse SDK Auth0 pour Angular pour les applications à page unique
...
Utilisez `déconnexion` pour déconnecter vos utilisateurs. Assurez-vous que `returnTo` est spécifié dans **URL de déconnexion autorisées**dans votre <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip>.
