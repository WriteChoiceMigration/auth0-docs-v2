...
Informez-vous davantage sur la question du [Stockage de jetons](/docs/secure/tokens/token-best-practices).
...
Redirigez vers le point de terminaison `/authorize` à Auth0, en démarrant le flux de [connexion universelle](/docs/universal-login) :
