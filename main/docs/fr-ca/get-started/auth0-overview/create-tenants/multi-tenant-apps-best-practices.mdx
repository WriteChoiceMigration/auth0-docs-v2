...
* Vous avez des groupes d’utilisateurs provenant de connexions différentes. Par exemple, un locataire pourrait demander aux utilisateurs de fournir des identifiants nom d’utilisateur/mot de passe, tandis qu’un autre locataire pourrait demander aux utilisateurs de se connecter par l’intermédiaire d’un <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip> d’entreprise.
...
Cette approche vous permet de partager l’accès à <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Auth0 Dashboard</Tooltip> avec des utilisateurs, restreints par locataire, mais vous oblige à configurer Auth0 individuellement pour chaque locataire.
