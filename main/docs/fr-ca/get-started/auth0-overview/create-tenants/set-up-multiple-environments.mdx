...
Avec la [Management API v2](/docs/api/management/v2), vous pouvez automatiser la migration des ressources ([règles](/docs/fr-ca/customize/rules), [connexions](/docs/connections) de base de données, etc.) entre les locataires.
