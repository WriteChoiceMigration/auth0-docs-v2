...
Pour protéger une API, vous devez enregistrer une API en utilisant l’<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip>. Pour en savoir plus, voir [Enregistrer des API](/docs/fr-ca/get-started/auth0-overview/set-up-apis).
