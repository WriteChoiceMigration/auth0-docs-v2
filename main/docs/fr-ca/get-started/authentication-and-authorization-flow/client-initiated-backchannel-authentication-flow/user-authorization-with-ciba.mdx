...
<Frame>![](/images/fr-ca/cdy7uua7fh8z/2i8E4sBBWhQueL4NTt9gz4/a05084a6fd6d39b017572e93c2c9c7b9/Screenshot_2025-06-02_at_1.20.07â__PM.png)</Frame>
...
* [Enroll the authorizing user in MFA using push notifications via the Guardian SDK](/docs/fr-ca/secure/multi-factor-authentication/auth0-guardian#enroll-in-push-notifications). To verify in the <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">Auth0 Dashboard</Tooltip>, navigate to **User Management > Users** and click on the user:

<Frame>![](/images/fr-ca/cdy7uua7fh8z/21qtk4F1cOQHMpbXxXYu75/51ba9c5fd1457ffee3f73893acf3c97f/Screenshot_2025-01-13_at_4.13.44_PM.png)</Frame>
...
* [Configure Rich Authorization Requests](/docs/fr-ca/get-started/apis/configure-rich-authorization-requests) for your <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-6" tip="">resource server</Tooltip>, which includes registering your `authorization_details` types.
