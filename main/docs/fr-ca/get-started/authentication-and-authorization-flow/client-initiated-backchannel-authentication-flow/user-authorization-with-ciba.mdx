...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/2i8E4sBBWhQueL4NTt9gz4/a05084a6fd6d39b017572e93c2c9c7b9/Screenshot_2025-06-02_at_1.20.07â__PM.png)</Frame>
...
* [Enroll the authorizing user in MFA using push notifications via the Guardian SDK](/docs/secure/multi-factor-authentication/auth0-guardian#enroll-in-push-notifications). To verify in the <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">Auth0 Dashboard</Tooltip>, navigate to **User Management > Users** and click on the user:
...
* [Configure Rich Authorization Requests](/docs/get-started/apis/configure-rich-authorization-requests) for your <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-6" tip="">resource server</Tooltip>, which includes registering your `authorization_details` types.
...
<td>The CIBA flow's requested expiry is between 1 and 300 seconds, and it defaults to 300 seconds. Include the <code>requested_expiry</code> parameter to set a custom expiry for the CIBA flow.</td>
</tr>
<tr>
