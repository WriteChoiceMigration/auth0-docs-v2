...
Pour autoriser l’utilisateur, votre application doit envoyer l’utilisateur à l’[URL d’autorisation](/docs/api/authentication#authorization-code-grant).
...
<td>Indique le type d’identifiant qu’Auth0 va retourner (code ou jeton). Pour ce flux, la valeur doit inclure <code>code</code>, mais peut aussi inclure <code>id_token</code>, <code>token</code>, ou <code>id_token token</code>. Spécifiquement, <code>id_token</code> renvoie un jeton d’ID, et <code>token</code> renvoie un jeton d’accès.</td>
</tr>
<tr>
<td><code>response_mode</code></td>
<td>Spécifie la méthode avec laquelle les paramètres de réponse doivent être retournés. Pour des raisons de sécurité, la valeur doit être <code>response_mode</code>. Dans ce mode, les paramètres de réponse seront chiffrés comme des valeurs de formulaire HTML qui sont transmises via la méthode HTTP POST et chiffrées dans le corps en utilisant le format <code>application/x-www-form-urlencoded</code></td>
</tr>
<tr>
...
<td>Une chaîne cryptographiquement aléatoire que votre application ajoute à la requête initiale et qu’Auth0 inclut dans le jeton d’ID, <a href="/docs/api-auth/tutorials/nonce">utilisée pour prévenir les attaques par réinsertion de jeton</a>.</td>
</tr>
<tr>
...
<td>Jeton d’accès (et valeurs <code>expires_in</code> et <code>token_type</code>)</td>
</tr>
<tr>
<td><code>id_token token</code></td>
<td>Jeton d’ID, Jeton d’accès (et valeurs <code>expires_in</code> et <code>token_type</code>)</td>
</tr>
</tbody>
</table>
