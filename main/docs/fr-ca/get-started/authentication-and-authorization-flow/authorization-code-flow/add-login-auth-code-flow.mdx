...
Pour autoriser l’utilisateur, votre application doit envoyer l’utilisateur à l’[URL d’autorisation](/docs/api/authentication#authorization-code-flow).
...
<td>Indique le type d’identifiant qu'Auth0 renverra (<code>code</code> ou <code>token</code>). Pour ce flux, la valeur doit être <code>code</code>.</td>
</tr>
<tr>
