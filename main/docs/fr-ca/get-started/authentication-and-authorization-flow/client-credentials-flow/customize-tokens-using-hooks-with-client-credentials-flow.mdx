...
---
# Personnalisation des jetons grâce aux hooks en utilisant le Flux des identifiants client
...
Copiez votre jeton d’accès et collez-le dans l’éditeur. Le <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">JWT</Tooltip> est décodé automatiquement et son contenu est affiché.
