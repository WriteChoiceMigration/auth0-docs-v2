...
Le flux d’authentification par voie de retour initié par le client (CIBA) est une norme <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OpenID</Tooltip> Foundation pour un flux d’authentification découplé. Il permet aux développeurs de créer des flux d’authentification où l’utilisateur ne se connecte pas directement sur l’appareil qui reçoit l’ID ou les jetons d’accès, ou sur l’appareil de consommation, mais sur un appareil d’authentification distinct.
...
<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/4MAnVR9sNU2OtlGQ12taaV/1b620f339336c1f591957157e4913bb1/Screenshot_2025-01-13_at_4.15.04_PM.png)</Frame>
...
<tbody>
<tr>
<td><a href="/docs/get-started/applications/configure-client-initiated-backchannel-authentication">Configurer une authentification Back-channel initiée par le client</a></td>
<td>Comment configurer le type d’autorisation CIBA pour votre application.</td>
</tr>
<tr>
<td><a href="/docs/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/user-authentication-with-ciba">Authentification des utilisateurs avec CIBA</a></td>
