...
* Choix de méthodes d’authentification multifacteur (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">MFA</Tooltip>) à partir du courriel, de la voix ou Duo
* Capacités d’authentification unique (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-5" tip="">SSO</Tooltip>)
...
Les jetons de l’Authentication API sont des jetons Web JSON (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-6" tip="">JWT</Tooltip>) structurés avec :
