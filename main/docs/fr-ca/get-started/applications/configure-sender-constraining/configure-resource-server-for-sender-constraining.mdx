...
Seuls les [clients confidentiels](/docs/get-started/applications/confidential-and-public-applications#confidential-applications) prennent en charge la liaison de jeton pour le protocole mTLS.
...
Le tableau suivant indique si les jetons d’accès émis sont limités par l’expéditeur en fonction de la configuration mTLS pour l’[application](/docs/get-started/applications/configure-mtls/configure-mtls-for-a-client) (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">OAuth</Tooltip> client ) et l’[API](/docs/get-started/applications/configure-mtls/set-up-resource-server-for-token-binding) (serveur de ressources OAuth). Le tableau couvre les scénarios suivants :
...
<Frame>![null](//images.ctfassets.net/cdy7uua7fh8z/3NRnK4mzW0hBosq9ovUdw1/a7307aad5ba79ad4c1dd964e5a1447ff/Screenshot_2024-05-28_at_11.56.40_AM.png)</Frame>
