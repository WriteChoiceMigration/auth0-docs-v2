...
<tr>
<td style="text-align:left">`urn:ietf:params:oauth:grant-type:device_code`</td>
...
<tbody>
<tr>
<td style="text-align:left">`http://auth0.com/oauth/grant-type/password-realm`</td>
...
<tr>
<td style="text-align:left">`http://auth0.com/oauth/grant-type/mfa-oob`</td>
<td style="text-align:left">Demande d’autorisation OOB Authentification multifacteur (MFA)</td>
</tr>
<tr>
<td style="text-align:left">`http://auth0.com/oauth/grant-type/mfa-otp`</td>
<td style="text-align:left">Demande d’autorisation OTP Authentification multifacteur (MFA)</td>
</tr>
<tr>
<td style="text-align:left">`http://auth0.com/oauth/grant-type/mfa-recovery-code`</td>
<td style="text-align:left">Demande d’autorisation de récupération de l'authentification multifacteur (MFA)</td>
</tr>
<tr>
<td style="text-align:left">`http://auth0.com/oauth/grant-type/passwordless/otp`</td>
