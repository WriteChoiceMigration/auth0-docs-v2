...
Les demandes d’autorisation sécurisées par <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">JWT</Tooltip> (JAR) permettent de regrouper les paramètres de requête d’autorisation OAuth2 en un seul paramètre de requête JWT, qui est ensuite signé pour protéger l’intégrité.
...
Vous pouvez configurer JAR pour une application avec <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Auth0 Dashboard</Tooltip> et <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">Management API</Tooltip>.
...
5. Si aucun identifiant n’est attribué et que des identifiants sont disponibles, vous serez invité à attribuer un identifiant existant.
   ...
   <Frame>![Dashboard > Application > Settings > Assign Existing Credentials](//images.ctfassets.net/cdy7uua7fh8z/HQHhFWTtdfNa5TnZ1dwx6/76bce36d82d24a38eeb0ae617f34b36e/Existing_Creds_-_French.png)</Frame>

6. Vous aurez également la possibilité d’attribuer un nouvel identiifant.

   <Frame>![Auth0 Dashboard > Applications > Settings > Assign New Credentials](//images.ctfassets.net/cdy7uua7fh8z/7JfsCBwytWO6Q7hUvdtSwJ/45b2bd194982fc08c87ecae761cfd340/New_Creds_-_French.png)</Frame>
