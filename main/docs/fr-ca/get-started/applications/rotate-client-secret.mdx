...
Vous pouvez modifier le secret client d’une application à l’aide de l’<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> ou du <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip>. Lorsque vous faites pivoter un secret client, vous devez mettre à jour toutes les applications autorisées avec la nouvelle valeur.
...
<tbody>
<tr>
<td><code>VOTRE_ID_CLIENT</code></td>
<td>Identifiant de l’application à mettre à jour.</td>
</tr>
<tr>
<td><code>MGMT_API_ACCESS_TOKEN</code></td>
<td><a href="/docs/api/management/v2/tokens">Jetons d’accès à Management API</a> avec la permission <code>update:client_keys</code>.</td>
</tr>
</tbody>
</table>
