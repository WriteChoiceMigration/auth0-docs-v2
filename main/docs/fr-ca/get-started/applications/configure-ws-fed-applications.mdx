...
Pour utiliser vos applications WS-Fed avec un domaine personnalisé et avec Auth0 comme <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">IdP</Tooltip>, mettez à jour votre fournisseur de services avec les nouvelles métadonnées de fournisseur d’identité d’Auth0. Vous pouvez obtenir les métadonnées à partir de :
