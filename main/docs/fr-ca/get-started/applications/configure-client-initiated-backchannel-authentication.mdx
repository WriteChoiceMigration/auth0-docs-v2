...
Dans <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> :

1. Sélectionnez **Security (Sécurité)>Multi-factor Auth. (Authentification multifacteur)**.

2. Activez l’option **Notification poussée via Gardien Auth0**. Cela peut nécessiter des paramètres de configuration de la <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">MFA</Tooltip>. Pour en savoir plus, consultez [Configurer les notifications poussées pour la MFA](/docs/fr-ca/secure/multi-factor-authentication/multi-factor-authentication-factors/configure-push-notifications-for-mfa).

<Frame>![](/images/fr-ca/cdy7uua7fh8z/7JKyznvsjTupJpTU7NwdSA/8bcc2b76930ba3fb7d5c72c7ae6e7f56/Enable_Guardian_MFA.png)</Frame>
...
<Frame>![](/images/fr-ca/cdy7uua7fh8z/54TD5VRQVAOWxBdnFEpvTT/1b19cb3704fdc9923881b60e7114fab8/CIBA_grant_type.png)</Frame>
