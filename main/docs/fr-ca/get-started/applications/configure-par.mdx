...
1. Accédez à <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> > > Paramètres > > Avancés.

2. Faites défiler vers le bas jusqu’à **Paramètres** et activez **Autoriser les demandes d’autorisation poussées (PAR)**.

<Frame>![](//images.ctfassets.net/cdy7uua7fh8z/4TBr65JaWE4homyb9NgntO/b9c74d6b4d55adac2a7f9b67bbeecfa5/Screenshot_2024-07-31_at_08.16.41.png)</Frame>
