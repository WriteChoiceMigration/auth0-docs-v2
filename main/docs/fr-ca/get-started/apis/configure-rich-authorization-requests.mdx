...
* Un modèle de [pages de connexion universelles personnalisées](/docs/fr-ca/customize/login-pages/universal-login/customize-templates). Consultez le document [Modèles de pages API](/docs/customize/universal-login-pages/universal-login-page-templates#page-templates-api) pour savoir comment personnaliser un modèle de page de connexion universelle à l’aide du <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>.
...
<th><strong><code>null</code> ou non défini (par défaut)</strong></th>
<th><code>transactional-authorization-with-mfa</code></th>
</tr>
</thead>
<tbody>
<tr>
...
<td>Oui</td>
<td>Non</td>
<td>La demande d’autorisation est rejetée avec <code>invalid_request</code>.</td>
<td>Le consentement personnalisé est affiché indépendamment des accès précédemment accordés.</td>
</tr>
<tr>
<td>Oui</td>
...
<Frame>![Dashboard > Applications > APIs > Settings > Access Settings](//images.ctfassets.net/cdy7uua7fh8z/3gr8Sf98gh8CUkjnlodNk/5262ab6330b4284087a7f87a719efd16/Access_Settings_-_API.png)</Frame>
