...
Vous pouvez ajouter des autorisations à une API à l’aide d’<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> ou de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip>.
...
1. Rendez-vous à [Dashboard > Applications > API](https://manage.auth0.com/#/apis) et cliquez sur le nom de l’API à afficher.
...
* nickname
* offline_access
* <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">openid</Tooltip>
* phone
* image
* profile
