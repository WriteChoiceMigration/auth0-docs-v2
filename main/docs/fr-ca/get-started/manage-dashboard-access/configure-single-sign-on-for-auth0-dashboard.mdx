...
* Les invitations de membres locataires ne peuvent ni être automatisées, ni être envoyées en masse avec Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-3" tip="">Management API</Tooltip>.
* L’accès des membres locataires ne peut pas être géré par vos appartenances au groupe IdP.
* La <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">MFA</Tooltip> ne peut pas être appliquée à tous les membres d’un locataire.
...
<td><code>E-Mail-Addresses</code> ou <code>User-Principal-Name</code></td>
</tr>
<tr>
...
Auth0 prend en charge la configuration de SSO pour le Dashboard avec un IdP <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-5" tip="">SAML</Tooltip> Google, mais nous recommandons de diriger les utilisateurs vers une méthode d’authentification de type Google.
...
Auth0 Support utilisera le [mode Implicit avec le flux Form Post](/docs/get-started/authentication-and-authorization-flow/implicit-flow-with-form-post), si disponible. Si votre IdP ne le prend pas en charge, vous aurez alors besoin de lui fournir le secret client de votre application.
...
<td>Identifiant du nom</td>
<td><code>http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier</code></td>
<td><code>upn</code> ou <code>emailaddress</code></td>
</tr>
<tr>
<td>Adresse courriel</td>
<td><code>http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress</code></td>
