...
Chaque utilisateur du <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> doit s’inscrire lui-même à l’authentification multifacteur (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">MFA</Tooltip>). Vous pouvez vous inscrire à la plupart des facteurs dans [Votre profil](https://manage.auth0.com/#/profile). Les caractéristiques biométriques des appareils nécessitent toutefois une inscription progressive.
...
<Frame>![undefined](//images.ctfassets.net/cdy7uua7fh8z/1cBjDSZrIeHAS2Fyzbt5HK/7045d8e2c5b0b0588d5eb88f4a5620b0/deviceenrollment.png)</Frame>
