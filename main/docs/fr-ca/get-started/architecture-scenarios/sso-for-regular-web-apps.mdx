...
* Auth0 prend en charge les normes ouvertes telles que OAuth 2.0 et <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OpenID Connect (OIDC)</Tooltip> pour l’authentification et l’autorisation (voir [Quel protocole utiliser](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-1#which-protocol-to-use))
* L’OIDC prend en charge plusieurs flux d’autorisation différents - le plus approprié pour les applications Web étant le flux de code d’autorisation (voir [Flux d’authentification](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-1#authentication-flow))
* Votre application sera configurée dans Auth0 en tant qu’application (voir [Application](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-2#application))
* Les fournisseurs d’identité seront configurés dans Auth0 en tant que connexion (voir [Connexions](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-2#connections))
* Auth0 fournit un widget Lock, qui permet aux utilisateurs de se connecter à l’application (voir [User Connexion](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#user-login))
* L’application web doit gérer l’état de la session pour garder une trace du fait que l’utilisateur est connecté. Parallèlement, Auth0 et le fournisseur d’identité gèrent également les informations de session. (voir [Gestion de session](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#session-management))
* Inversement, la déconnexion d’un utilisateur implique également trois couches de gestion de session (voir [Déconnexion de l’utilisateur](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#user-logout))
* Le contrôle d’accès peut être géré avec Auth0 Authorization Extension (voir [Contrôle d’accès](/docs/get-started/architecture-scenarios/sso-for-regular-web-apps/part-3#access-control)) :::
...
<Frame>![Diagramme de la solution](//images.ctfassets.net/cdy7uua7fh8z/7hg1vqzNEJ2RG1JYw0pxFp/80f8067100e8463b6105f9a08deb069b/solution-diagram.png)</Frame>
