...
'description': "Vérifications de la conformité à effectuer avant le lancement de votre mise en œuvre IAM B2B."
'og:title': "Préparation à la conformité (B2B)"
'og:description': "Vérifications de la conformité à effectuer avant le lancement de votre mise en œuvre IAM B2B."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/img/share-image.png"
'twitter:title': "Préparation à la conformité (B2B)"
'twitter:description': "Vérifications de la conformité à effectuer avant le lancement de votre mise en œuvre IAM B2B."
---
...
Vous devriez publier une politique de conservation des données et l’appliquer automatiquement. Auth0 Management API ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Auth0 Dashboard</Tooltip> peuvent être utilisés pour faciliter la [suppression des comptes utilisateurs](/docs/fr-ca/secure/data-privacy-and-compliance/gdpr/gdpr-right-to-access-correct-and-erase-data).

## Protection des données personnelles

Que vous soyez responsable du traitement des données ou que vous y contribuiez, vous avez l’obligation de protéger les données personnelles que vous détenez sur les utilisateurs. Cela comprend l’utilisation du chiffrement dans la mesure du possible, ainsi que la mise en place de mesures de sécurité raisonnables pour protéger les comptes d’utilisateurs. Avant le lancement, vous devez vérifier si vous utilisez toutes les fonctionnalités de sécurité disponibles dans Auth0, comme la détection des attaques par force brute, l’authentification multifacteur (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">MFA</Tooltip>) (pour les utilisateurs et les administrateurs) et une politique relative aux mots de passe robuste. Assurez-vous également que vous avez un processus en place pour parer aux attaques par force brute.
