...
Un [fournisseur d’identité](/docs/connections) rempli le profil de l’utilisateur avec les données fournies lors du processus de connexion, ce que l’on appelle le [profil utilisateur normalisé](/docs/fr-ca/manage-users/user-accounts/user-profiles/normalized-user-profiles).
