...
[Télécharger](/docs/package/v2?org=auth0-samples&repo=auth0-pnp-exampleco-timesheets&path=timesheets-mobile/android)
...
* [JWTDecode.Android](https://github.com/auth0/JWTDecode.Android) : ce package aidera à décoder les <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">JWT</Tooltip>.
