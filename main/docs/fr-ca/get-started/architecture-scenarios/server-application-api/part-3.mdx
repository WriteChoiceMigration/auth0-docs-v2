...
Voir l’implémentation dans [Node.js](/docs/get-started/architecture-scenarios/server-application-api/api-implementation-nodejs#1-define-the-api-endpoint).
...
**Voir l’implémentation dans**[**Node.js**](/docs/get-started/architecture-scenarios/server-application-api/api-implementation-nodejs#2-secure-the-api-endpoint)**.**
...
* **<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Audience</Tooltip>** : Identifiant de l’API
...
**Voir l’implémentation dans**[**Python**](/docs/get-started/architecture-scenarios/server-application-api/cron-implementation-python#get-an-access-token).
...
**Voir l’implémentation dans**[**Python**](/docs/get-started/architecture-scenarios/server-application-api/cron-implementation-python#invoke-the-api).