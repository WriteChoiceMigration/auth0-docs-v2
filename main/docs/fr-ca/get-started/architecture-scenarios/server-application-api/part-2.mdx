...
<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OAuth 2.0</Tooltip> définit le type de profils, ou dialectes, pour un jeton d’accès. Auth0 prend en charge deux profils différents :
...
Lorsque vous créez une API, vous devez sélectionner l’algorithme avec lequel vos jetons seront signés. La signature est utilisée pour vérifier que l’expéditeur du jeton Web JSON (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">JWT</Tooltip>) est bien celui qu’il prétend être et pour s’assurer que le message n’a pas été modifié en cours de route.
...
<Frame>![Dashboard > API > Permissions](//images.ctfassets.net/cdy7uua7fh8z/73FeuGyODcu3q7PKjLaQOO/f3bbc7875e527a6a32ae66b1e1432978/Timesheets_API_-_Permissions_-_French.png)</Frame>
...
<Frame>![undefined](//images.ctfassets.net/cdy7uua7fh8z/7lnuzFgs3IuWyL4bK5aVZV/fc3bb9e27b8960d5ea5521e226cb7e42/2025-02-26_19-05-30.png)</Frame>
...
<Frame>![Dashboard (Tableau de bord) - Applications - APIs (APIs) - Machine to Machine Applications (Applications machine-machine) - Authorize (Autoriser)](//images.ctfassets.net/cdy7uua7fh8z/3PjvkTaoOZKWCMJol4ajCu/7f25c09888f0688c4cf1c517bdc62aaa/2025-02-26_18-53-09.png)</Frame>
