...
* Pour utiliser des variables dans les scripts de base de données personnalisés, vérifiez les [paramètres de configuration](/docs/connections/database/custom-db/create-db-connection#step-3-add-configuration-parameters)
