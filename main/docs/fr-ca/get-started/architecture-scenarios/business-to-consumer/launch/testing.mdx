...
'og:description': "Préparation des tests pour le lancement de votre implémentation IAM de commerce de détail (B2C)."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/img/share-image.png"
'twitter:title': "Tests effectués (commerce de détail)"
'twitter:description': "Préparation des tests pour le lancement de votre implémentation IAM de commerce de détail (B2C)."
---
...
* Pour l’utilisation de variables dans les Scripts de base de données personnalisés, consultez les [paramètres de configuration](/docs/connections/database/custom-db/create-db-connection#step-3-add-configuration-parameters)
