...
* Auth0 issues tokens for [authentication and authorization](/docs/fr-ca/get-started/identity-fundamentals/authentication-and-authorization) as the <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-3" tip="">identity provider</Tooltip>.
...
<Frame>![](/images/fr-ca/cdy7uua7fh8z/4nhWTT6iqS5CBWwXNuE5Ay/4542db5febc85dc5938958fa4b205a7e/2025-03-26_12-09-22.png)</Frame>

1. The public part of the signing key is imported to Auth0 and pend publication to Auth0 keys as an aggregated [JWKS](/docs/fr-ca/secure/tokens/json-web-tokens/json-web-key-sets).
2. The public signing key is published to the well-known endpoint of your tenant’s [custom domain](/docs/fr-ca/customize/custom-domains): `{yourCustomDomain}/.well-known/jwks.json`.
...
* Configure a <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">Custom Domain</Tooltip>. The aggregated JWKS is served from a custom domain and is not available on the canonical domain. To learn more, read [Custom Domains.](/docs/fr-ca/customize/custom-domains)
* Use Auth0’s Private Cloud. You can only import signing keys in Private Cloud environments. To learn more, read about our Private Cloud on [AWS](/docs/fr-ca/deploy-monitor/deploy-private-cloud/private-cloud-on-aws) and [Azure](/docs/fr-ca/deploy-monitor/deploy-private-cloud/private-cloud-on-azure).
