...
Pendant l’exécution de plusieurs flux, votre application doit aussi être authentifiée auprès du serveur d’autorisations. Pour en savoir plus sur l’authentification des applications, lisez [Authentifiants d’application](/docs/secure/application-credentials).
...
* [Flux d’authentification par canal d’appui initié par le client](/docs/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow)
* [Authentification des utilisateurs avec CIBA](/docs/get-started/authentication-and-authorization-flow/client-initiated-backchannel-authentication-flow/user-authentication-with-ciba)