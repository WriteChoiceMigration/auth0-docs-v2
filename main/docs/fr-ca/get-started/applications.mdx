...
* **Type d’application**: Pour ajouter l’authentification à votre application, vous devez l’enregistrer dans <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> et sélectionner l’un des types d’application suivants :
...
Vous pouvez [supprimer une application](/docs/fr-ca/get-started/applications/remove-applications) à partir du Dashboard ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip>.
