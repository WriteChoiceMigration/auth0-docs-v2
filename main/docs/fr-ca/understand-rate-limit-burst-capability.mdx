...
---
# Comprendre la capacité de limite anti-attaques
...
En gardant à l’esprit la façon dont un exemple de réceptacle de point de terminaison est configuré, examinons les limites de charge subite de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> Auth0 par type d’abonnement :
