...
* `connection.name` (à l’exception du **Courriel pour l’inscription à l’authentification multifactorielle (<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip>)** )
