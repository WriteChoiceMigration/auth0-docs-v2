...
Lorsque vous n’avez plus besoin de hooks, vous pouvez les supprimer à l’aide du Dashboard ou de <Tooltip href="/docs/fr-ca/glossary?term=management-api" tip="Management API
