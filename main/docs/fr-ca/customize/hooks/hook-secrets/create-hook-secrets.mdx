...
<td>[Jeton d’accès à Management API] (/api/management/v2/tokens) avec la <Tooltip tip="Permission Mécanisme qui détermine les actions que les applications peuvent effectuer au nom d’un utilisateur avec des informations préalablement créées dans une ressource en ligne." cta="Voir le glossaire" href="/docs/glossary?term=scope"> permission</Tooltip> `create:hooks`.</td>
</tr>
<tr>
<td>`HOOK_ID`</td>
