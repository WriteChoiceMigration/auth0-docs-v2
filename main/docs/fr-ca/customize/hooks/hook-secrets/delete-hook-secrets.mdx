...
<td>Jetons d’accès à Management API avec le <Tooltip tip="Permission Mécanisme qui détermine les actions que les applications peuvent effectuer au nom d’un utilisateur avec des informations préalablement créées dans une ressource en ligne." cta="Voir le glossaire" href="/docs/glossary?term=scope">scope</Tooltip> `update:hooks`. Pour en savoir plus, lisez [Jetons d’accès à Management API] (/api/management/v2/tokens).</td>
</tr>
<tr>
