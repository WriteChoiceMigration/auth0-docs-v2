...
2. Cliquez sur la liste déroulante située juste en dessous du nom et de la description du point d’extensibilité.
   ...
   <Frame>![Auth0 Hook selection](//images.ctfassets.net/cdy7uua7fh8z/2LCBPLtrsjmmJYxCGfWquT/74b232fd96aa179c89f01e46d2e91ce3/dashboard-hooks-list.png)</Frame>
...
Effectuez une requête `PATCH` au [point de terminaison Mise à jour d’un hook](/docs/api/management/v2/#!/Hooks/patch_hooks_by_id). Assurez-vous de remplacer les valeurs des paramètres fictifs `HOOK_ID` et `MGMT_API_ACCESS_TOKEN` avec l’ID de votre appel et votre jeton d’accès de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>, respectivement.
