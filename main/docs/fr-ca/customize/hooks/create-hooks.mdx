...
<td>Jeton d’accès à Management API avec la <Tooltip tip="Permission Mécanisme qui détermine les actions que les applications peuvent effectuer au nom d’un utilisateur avec des informations préalablement créées dans une ressource en ligne." cta="Voir le glossaire" href="/docs/glossary?term=scope"> permission</Tooltip> `create:hooks`. Pour en savoir plus, lisez .</td>
</tr>
<tr>
<td>`HOOK_NAME`</td>
