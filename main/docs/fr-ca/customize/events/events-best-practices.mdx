...
You can change the events that a webhook endpoint receives by [updating event streams](/docs/fr-ca/customize/events/create-an-event-stream).
...
* [Create an Event Stream](/docs/fr-ca/customize/events/create-an-event-stream)
