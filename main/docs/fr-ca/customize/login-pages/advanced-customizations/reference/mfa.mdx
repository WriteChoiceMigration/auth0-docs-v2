...
La classe d’écran Commencer l’inscription à la <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> gère la sélection et l’inscription des facteurs MFA.
