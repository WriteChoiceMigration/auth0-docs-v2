...
---
# Classes d’écran authentification multifacteur (MFA) par courriel

## Classe d’écran Défi-réponse de la MFA par courriel

La classe d’écran Défi-réponse de la <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> par courriel permet aux utilisateurs de vérifier leur adresse courriel à l’aise de la MFA.
