...
La classe d’écran Défi-réponse de la <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> par SMS fournit des méthodes associées à l’écran mfa-sms-challenge.
