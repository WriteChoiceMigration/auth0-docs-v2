...
La classe d’écran Défi-réponse de la <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> par notification poussée est affichée lorsqu’une notification poussée a été envoyée à l’appareil de l’utilisateur.
