...
<td>Non</td>
<td>Données supplémentaires collectées auprès de l’utilisateur. Ces données sont accessibles dans le déclencheur d’action <code>post-login</code>.</td>
</tr>
</tbody>
</table>
...
<td>Non</td>
<td>Données supplémentaires recueillies auprès de l’utilisateur. Les données sont accessibles dans le déclencheur d’action <code>post-login</code>.</td>
</tr>
</tbody>
</table>
...
|  |
| --- |
| Connexion SMS OTP sans mot de passe |
