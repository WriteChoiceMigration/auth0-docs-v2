...
Vous pouvez configurer les options suivantes à partir d’<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> sous l’onglet [Image de marque > Connexion universelle > Paramètres](https://manage.auth0.com/#/login_settings) :
