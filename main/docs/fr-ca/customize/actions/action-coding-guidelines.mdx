...
* Veiller à ce que les Actions qui fournissent une vérification ou déclenchent une <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip> ne puissent être contournées de façon non intentionnelle ou malveillante.
