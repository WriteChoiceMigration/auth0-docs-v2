...
---
# Déclencheurs d’actions : pre-user-registration - Objet API
...
Remarque : ce déclencheur effectue un appel à <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>, consommant la limite anti-attaques de Management API. Si cette demande atteint la limite anti-attaques et échoue dans sa nouvelle tentative dans la fenêtre de délai d’expiration, l’API renvoie une erreur `Deadline Exceeded`.
