...
The Pre-user Registration trigger runs before a user is added to a Database or <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Passwordless</Tooltip> Connection.

<Frame>![Diagram showing the Actions Pre User Registration Flow.](//images.ctfassets.net/cdy7uua7fh8z/2KtUcZhaBcT12GxjhBJZFG/9633b4454ac1c06c0deed6c97e70fe7d/pre-user-registration-flow.png)</Frame>
