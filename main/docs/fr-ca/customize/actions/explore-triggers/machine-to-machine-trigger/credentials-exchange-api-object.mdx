...
---
# Déclencheurs d’actions : credentials-exchange - API Object
...
<td>
<p>
<em>Chaîne</em>. Le code d’erreur OAuth justifiant le rejet de la connexion. Doit être l’une des valeurs suivantes : <code>'invalid_scope'</code>,  <code>'invalid_request'</code>, ou <code>'server_error'</code>
</p>
</td>
</tr>
<tr>
...
[Limites de caches des actions](/docs/customize/actions/limitations).
...
<em>Numéro facultatif</em>. L’heure d’expiration absolue en millisecondes
            ...
            <code>expires_at</code> fournie.
          </p>
<p>
<em>Remarque :</em> Cette valeur ne doit pas être fournie si une valeur a également été donnée
            pour <code>ttl</code>. La première des deux échéances sera retenue
...
<em>Numéro facultatif</em>. Valeur de la durée de vie de cette entrée de cache
            ...
            elles ne resteront jamais au-delà de la valeur <code>ttl</code> fournie.
          </p>
<p>
<em>Remarque :</em> Cette valeur ne doit pas être fournie si une valeur a également été donnée
            pour <code>expires_at</code>. La première des deux échéances sera retenue
            si les deux options sont fournies.
          </p>
</td>
</tr>
