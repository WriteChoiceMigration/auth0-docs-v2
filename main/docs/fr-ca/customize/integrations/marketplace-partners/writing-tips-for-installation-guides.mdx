...
| **Preferred** | **Discouraged** | |-----------|-------------| | Vous pouvez utiliser <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip> ou <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip> pour [personnaliser le texte pour la nouvelle expérience de connexion universelle] (/docs/customize/universal-login-pages/universal-login-page-templates). | Cliquez [ici] (/docs/get-started). | | Pour apprendre comment attribuer des rôles aux membres d’organisations, lisez [Ajouter des rôles aux membres d’organisation] (/docs/manage-users/organizations/configure-organizations/add-member-roles). | Vous pouvez consulter [ce lien](/docs/fr-ca/articles). |
...
| **Preferred** | **Discouraged** | |-----------|-------------| | Sélectionnez **Create** (Créer). |Cliquez sur **Create** (Créer). | | Passez à la vue **Applications**. | Passez à l’onglet **Applications**. | | Localisez le **<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">Client Secret</Tooltip>** (Secret client). | Faites défiler l’écran vers le haut jusqu’au **Client Secret** (Secret client). |
...
| **Preferred** | **Discouraged** | |-----------|-------------| | Connectez-vous à votre compte. | Connectez-vous à votre compte. | | Auth0 traite les connexions. | Auth0 traite les connexions. | | Configurez votre matériel. | Configurez votre matériel. | | Décrivez votre configuration matérielle. | Décrivez votre configuration matérielle. |
...
| **Preferred** | **Discouraged** | |-----------|-------------| | Pour installer la trousse SDK : | Suivez les étapes ci-dessous : |
