...
Pour accéder à des points de terminaison de <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> supplémentaires depuis les règles, vous devez utiliser une version différente de la bibliothèque.
