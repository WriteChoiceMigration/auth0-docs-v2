...
<Frame>![Dashboard > Actions > Forms > Flows > Execution](//images.ctfassets.net/cdy7uua7fh8z/448jfjHtgCxfIeDOakuHyd/fba64deda0cf920f399de2190e94bdc9/Flows-execution.png)</Frame>
...
<Frame>![Dashboard > Actions >  Forms > Flows > Executions](//images.ctfassets.net/cdy7uua7fh8z/1VqWEaVZg5lrXatXe9dbFB/dbcf7edca5aabdfc544f04cb18be4149/Flow-execution-details.png)</Frame>
...
<Frame>![Dashboard > Actions > Forms > Form](//images.ctfassets.net/cdy7uua7fh8z/5aeniTfHXplDyZfwCKBcgK/a2098a476edde76da10a527b0a606e95/Flow-error.png)</Frame>
...
2. Localisez le flux associé au nœud de l’étape.
   ...
   <Frame>![Dashboard > Actions > Forms > Form](//images.ctfassets.net/cdy7uua7fh8z/4LjULYyo0nhtNowm7J5okz/27ea3f8386bb5015d447c48facf6b90f/flow-error-linked.png)</Frame>
...
<Frame>![Dashboard > Actions > Forms > Flow > Execution](//images.ctfassets.net/cdy7uua7fh8z/6QNYKDqG9AIOEzQkP6Fnnr/db885e146179a0490eddd5ad6cb518dc/Flow-execution-failed.png)</Frame>
...
<Frame>![Dashboard > Actions > Forms > Flow > Execution > Error](//images.ctfassets.net/cdy7uua7fh8z/1kaKihtJtv8VvNAyTkW4cC/6b34bcecc8642d7d97aaf2c8dec51ebc/flow-execution-error-view.png)</Frame>
...
<Frame>![Dashboard > Actions > Forms > Flows](//images.ctfassets.net/cdy7uua7fh8z/4YLRVNbzK5LjJEQjFXIJXM/5003833784ce5b0d9f63730ed46ff047/Action-typo-error.png)</Frame>

<Note>

Si un champ est configuré comme transitoire ou si sa valeur est masquée par une [fonction Helper](/docs/customize/forms/variables#helper-functions), la valeur n’est pas disponible pour le débogage.

<Frame>![Dashboard (Tableau de bord) > Actions > Forms (Formulaires) > Flows (Flux) > Execution (Exécution)](//images.ctfassets.net/cdy7uua7fh8z/4MVtjnVD50cG63ocN5a458/c0337a94d1f4c21f28d06e28ec59121e/masked-information.png)</Frame>
