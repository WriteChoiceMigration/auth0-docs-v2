...
* **callback(error, query)**: Callback auquel vous pouvez renvoyer une erreur ou la requête lucene utilisée lors du filtrage des utilisateurs. L’extension enverra cette requête au point de terminaison [**Obtenir les utilisateurs** de Management API.](/docs/api/management/v2#!/Users/get_users)
