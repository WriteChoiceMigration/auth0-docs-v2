...
* **callback(error, user)** : Rappel auquel vous pouvez renvoyer une erreur et l’objet utilisateur qui doit être envoyé au <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>.
