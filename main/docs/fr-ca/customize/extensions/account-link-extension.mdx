...
Une fois connecté, vérifiez les détails de l’utilisateur sur <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Auth0 Dashboard</Tooltip>. Ici, nous pouvons voir que les comptes utilisateurs sont liés.
...
3. Vers le bas de l’objet de configuration du gadget logiciel Lock, ajoutez la ligne suivante (après le paramètre `closable`) :
   ...
   <Frame>![Dashboard - Marquage - Connexion universelle - Paramètre de connexion - Exemple de code de page hébergée avec lien de compte](//images.ctfassets.net/cdy7uua7fh8z/7gejLGgQB5hoLPqEAJXY5w/a8490d56124fc1057ca2712c783569bf/2025-02-28_14-28-58.png)</Frame>
