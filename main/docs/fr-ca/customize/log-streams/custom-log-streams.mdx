...
1. Accédez à [Dashboard > Surveillance > Flux](https://manage.auth0.com/#/log-streams)  et cliquez sur **Créer le flux.**.
   ...
   <Frame>![Dashboard Monitoring Streams](//images.ctfassets.net/cdy7uua7fh8z/5ZY6sT68DabXNL9Dr4bhss/ff0f7306fcf9d64247a61a48b12a39a9/log_stream.png)</Frame>
...
3. Configurer les paramètres suivants :
   ...
   <Frame>![Dashboard Monitoring Streams Custom Webhook Settings Tab](//images.ctfassets.net/cdy7uua7fh8z/5vJVD09aqSF0xEZZFk6wh2/e6469041b2dd1e4f1b142961ca0a12ab/custom-webhook-settings.png)</Frame>
