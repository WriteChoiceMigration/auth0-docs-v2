...
Event delivery will automatically retry. To learn more, review [Best Practices](/docs/ja-jp/customize/events/event-testing-observability-and-failure-recovery#batch-redelivery-of-failed-events).
