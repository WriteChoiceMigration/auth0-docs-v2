...
<td>必要ならば、デフォルトの<dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">スコープ</span></dfn>を指定します。</td>
</tr>
</tbody>
</table>
