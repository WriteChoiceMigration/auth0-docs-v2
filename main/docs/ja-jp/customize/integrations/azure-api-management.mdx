...
<td>テナントの<a href="https://{yourDomain}/.well-known/openid-configuration">OIDCディスカバリーエンドポイント</a>を参照して`audience`パラメーターを追加します。例：`https://{yourDomain}/authorize?audience={API_AUDIENCE}`</td>
</tr>
<tr>
