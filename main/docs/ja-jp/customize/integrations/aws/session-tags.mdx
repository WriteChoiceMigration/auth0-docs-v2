...
<tr>
<td>1</td>
<td>キー：<code>CostCenter</code>、値：<code>marketing</code><br/>キー：<code>Project</code>、値：<code>website</code></td>
</tr>
<tr>
<td>2</td>
<td>キー：<code>CostCenter</code>、値：<code>engineering</code><br/>キー：<code>Project</code>、値：<code>management_dashboard</code></td>
</tr>
<tr>
<td>3</td>
<td>キー：<code>CostCenter</code>、値：<code>marketing</code><br/>キー：<code>Project</code>、値：<code>community_site</code></td>
</tr>
</tbody>
</table>
...
<td>前提条件で作成したIDプロバイダーの名前（例：<code>auth0SamlProvider</code>）。**［Allow programmatic and AWS Management Console access（プログラムとAWSマネジメントコンソールによるアクセスを許可する）］**を選択します。</td>
</tr>
</tbody>
</table>
...
<td>ロールの説明的な名前。たとえば<code>AccessByCostCenter</code>。</td>
</tr>
<tr>
...
ログインするには、AWSコンソールの<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">SSO</Tooltip>ログインが必要です。これを見つけるには:
