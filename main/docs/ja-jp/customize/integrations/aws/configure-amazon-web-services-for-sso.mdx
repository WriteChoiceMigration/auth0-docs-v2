...
<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">SSO</Tooltip>にAWSを構成するには、以下の手順を完了させる必要があります。
...
<tbody>
<tr>
<td><strong>Role name（ロール名）</strong></td>
<td>ロールの説明的な名前。</td>
</tr>
<tr>
<td><strong>Role description（ロールの説明）</strong></td>
<td>ロールを使用する目的の説明。</td>
</tr>
</tbody>
</table>
...
高度なユースケースでロールを割り当てるサーバー側ルールについては、[Amazon API Gatewayのチュートリアル](/docs/customize/integrations/aws/aws-api-gateway-delegation/aws-api-gateway-delegation-5)を参照してください。
