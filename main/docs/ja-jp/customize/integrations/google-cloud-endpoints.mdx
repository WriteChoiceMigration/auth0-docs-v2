...
<td><dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">JSON Web Token（JWT）</span></dfn>署名の検証に使用される公開鍵のURIです。これは`"https://{yourDomain}/.well-known/jwks.json"`に指定します。</td>
</tr>
<tr>
