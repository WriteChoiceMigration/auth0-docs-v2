...
* [Amazonログインをアプリに追加する](/docs/connections/social/amazon)：ユーザーがAmazonプロファイルを使ってアプリにログインできるようにします。
