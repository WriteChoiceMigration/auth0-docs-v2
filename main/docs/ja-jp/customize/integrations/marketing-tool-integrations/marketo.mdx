...
'og:description': "Auth0のユーザーデータのエクスポートとMarketoへのインポート方法について説明します。"
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/img/share-image.png"
'twitter:title': "Marketoにユーザーデータをエクスポートする"
'twitter:description': "Auth0のユーザーデータのエクスポートとMarketoへのインポート方法について説明します。"
---
...
インポートのステータスは、[Get Import Lead Status API](/docs/)とインポートジョブの`batchId`を使用して確認できます。例：
