...
* 最新版の[Auth0 Next.js SDK](/docs/ja-jp/quickstart/webapp/nextjs#install-the-auth0-next-js-sdk)を使用したNext.jsアプリケーション
...
4. 正しいAuth0アカウントでログインしていて、正しいテナントのダッシュボードに統合していることを確認します。
   ...
   * Auth0を初めて使う場合は、そこでAuth0アカウントを作成します。</Callout>
