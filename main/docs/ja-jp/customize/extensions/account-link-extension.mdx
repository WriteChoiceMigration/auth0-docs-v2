...
<Frame>![Dashboard - Extensions - Account Link - Extension Example](/images/ja-jp/cdy7uua7fh8z/5K3KBOkhyP1SbAVaYg1yxD/618568208eca3cd15000d716ae9a1e00/account-linking-extension.png)</Frame>
...
3. Lockウィジェットを構成するオブジェクトの下部（`closable`設定の後）に次の行を追加します：
   ...
   <Frame>![Dashboard - ブランディング - ユニバーサルログイン - ログイン設定 - アカウントリンク ホストされたページコード例](/images/ja-jp/cdy7uua7fh8z/7gejLGgQB5hoLPqEAJXY5w/023a2d02ab4976b8b7dc59d4dbc37c56/Universal_Login_-_Login_-_Japanese.png)</Frame>

4. 変更を保存して、アカウントのリンクを試みます。**［Sign Up（サインアップ）］** オプションが非表示になり、これでユーザーの混乱を防ぐことができます。

   <Frame>![Account Link Hosted Page Example](/images/ja-jp/cdy7uua7fh8z/5LHWcm49M29Y00rI5xDaZV/773621dc56b4bff67ea618b2c919f750/hosted-page-example.png)</Frame>
...
<Frame>![Account Link Customize Theme](/images/ja-jp/cdy7uua7fh8z/2as3Sx9y6UB0tyIuyJikR7/ee4ce139c19a0c2b8125e28b9059939e/extension-page-example.png)</Frame>
