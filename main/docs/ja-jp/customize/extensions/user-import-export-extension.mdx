...
<Frame>![Dashboard Extensions Authorize the Users Import/Export Extension](/images/ja-jp/cdy7uua7fh8z/5CCKmxUv1HN5nDj9jL8qel/d7f02ccf3f4be166b00bbf217e14144f/Screen_Shot_2021-05-18_at_9.11.01_PM.png)</Frame>
...
Auth0テナントからエクスポートしたファイルを使用する場合は、`ndjson`から[JSON](/docs/ja-jp/manage-users/user-migration/bulk-user-exports#json-compatible-format)に変換する必要があります。同じユーザーIDを維持するために、インポートするユーザーIDから`auth0| prefix`を削除しなければなりません。
...
<Frame>![Dashboard Extensions Users Import Export Import Complete](/images/ja-jp/cdy7uua7fh8z/7hyE3DWBJuFuAulAAnZlfN/23303644d4c706f4c0937bd363bf6699/import-complete.png)</Frame>
...
<Frame>![Dashboard Extensions Users Import Export Export Users page](/images/ja-jp/cdy7uua7fh8z/5wUhbGMjVQKIE9vx2SBIA3/a952aee6cc6027234631334c7174c4a8/export-users.png)</Frame>
...
* **［Export Format（エクスポート形式）］**を選択します。JSONファイルとCSVファイルから選択できます。
  ...
  <Frame>![Dashboard 拡張機能 ユーザーのインポートエクスポート 設定 エクスポート形式](/images/ja-jp/cdy7uua7fh8z/1HVpo1IevSRJbFvwrEKkzf/761fa914f6c33cdee147e07b2c43f7c7/settings.png)</Frame>
...
Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>では、ユーザーインポート/エクスポート拡張機能を使用して、`user_metadata`および `app_metadata`へのユーザープロファイルの一括更新が可能です。
...
[上記のエクスポートプロセス](/docs/ja-jp/customize/extensions/user-import-export-extension#export-users)を使用して、すべてのユーザー属性を含む完全なエクスポートファイルを作成します。
