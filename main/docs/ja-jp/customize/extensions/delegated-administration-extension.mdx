...
組織内の他のユーザーや管理者にテナント使用機能を委任する場合は、［Tenant Members（テナントメンバー）］設定の使用をお勧めします。詳細については、「[ダッシュボードへのアクセス](/docs/get-started/manage-dashboard-access)」をお読みください。
...
作成したら、アプリケーションの**［<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Client ID</Tooltip>（クライアントID）］**値をメモしてください。
...
委任管理拡張機能（DAE）のある組織を使ってユーザーとしてログインする場合は、ユーザーロールを利用できません。`event.authorization.roles`には組織メンバーのロールのみ使用できます。組織メンバーにロールを追加するには、「[組織メンバーにロールを追加する](/docs/manage-users/organizations/configure-organizations/add-member-roles)」をお読みください。
...
<td>オーストラリア</td>
<td>AU</td>
<td><code>https://{yourTenant}.au.webtask.io/auth0-delegated-admin</code></td>
</tr>
<tr>
<td>欧州</td>
<td>EU</td>
<td><code>https://{yourTenant}.eu.webtask.io/auth0-delegated-admin</code></td>
</tr>
<tr>
<td>欧州</td>
<td>EU-2</td>
<td><code>https://{yourTenant}.eu.webtask.run/auth0-delegated-admin</code></td>
</tr>
<tr>
<td>日本</td>
<td>JP-1</td>
...
<td>英国</td>
<td>UK</td>
<td><code>https://{yourTenant}.uk.webtask.run/auth0-delegated-admin</code></td>
</tr>
<tr>
<td>米国</td>
<td>US-1</td>
<td><code>https://{yourTenant}.us.webtask.io/auth0-delegated-admin</code></td>
</tr>
<tr>
<td>米国</td>
<td>US-3</td>
