...
To reset the custom email provider, navigate to [Auth0 Dashboard > Branding](https://auth0.com/docs/$manage_url#/branding) and select **Email Provider**. Then, select the **Reset** button to restore your custom provider to its default