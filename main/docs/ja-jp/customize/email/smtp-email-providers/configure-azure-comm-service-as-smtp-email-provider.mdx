...
---
# Azure Communication Servicesを外部SMTPメールプロバイダーとして構成する
...
3. IPのリストを更新します。詳細については、「[許可リスト用のAuth0 IPアドレス](/docs/ja-jp/secure/security-guidance/data-security/allowlist)
