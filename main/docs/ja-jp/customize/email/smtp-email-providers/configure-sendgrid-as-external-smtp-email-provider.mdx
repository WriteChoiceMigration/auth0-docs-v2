...
**注意：**[メールを使ったパスワードレス認証](/docs/ja-jp/authenticate/passwordless#email)を使用している場合には、パスワードレス接続の**［From（差出人）］**のメールアドレス値がSendGridに使用している**［From（差出人）］**のメールアドレス値と一致していることを確認してください。
