...
このガイドの終わりには、カスタマイズしたサインアップ画面のあるIdentity Firstフローが完成します。詳細については、「[使用の開始ガイド](/docs/ja-jp/customize/login-pages/advanced-customizations/getting-started)」をお読みの上で、「[SDKリファレンスガイド](/docs/ja-jp/customize/login-pages/advanced-customizations/getting-started/sdk-quickstart)」を参照してください。
