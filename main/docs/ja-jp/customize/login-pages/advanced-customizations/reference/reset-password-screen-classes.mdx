...
パスワードリセット画面クラスは[Identifier First認証](/docs/ja-jp/authenticate/login/auth0-universal-login/identifier-first)フローの一部で、ユーザーのパスワードをリセットします。
...
パスワードリセットメール画面クラスは[Identifier First認証](/docs/ja-jp/authenticate/login/auth0-universal-login/identifier-first)フローの一部で、ユーザーにパスワードをリセットする手順を送信します。
...
パスワードリセットエラー画面クラスは[Identifier First認証](/docs/ja-jp/authenticate/login/auth0-universal-login/identifier-first)フローの一部で、ユーザーをアプリケーションに戻します。
...
パスワードリセット要求画面クラスは[Identifier First認証](/docs/ja-jp/authenticate/login/auth0-universal-login/identifier-first)フローの一部で、パスワードのリセット方法をメールで送信するために、ユーザーにメールアドレスを求めます。
...
パスワードリセット成功画面クラスは[Identifier First認証](/docs/ja-jp/authenticate/login/auth0-universal-login/identifier-first)フローの一部で、パスワードの変更を確認し、ユーザーをアプリケーションに戻します。
