...
このイベント[`(fn)`](/docs/ja-jp/deploy-monitor/logs/log-event-type-codes)はエラーとしてログに記録されますが、その後、アクションには送信されません。
...
このイベント[`(fn)`](/docs/ja-jp/deploy-monitor/logs/log-event-type-codes)はエラーとしてログに記録され、その後、数分にかけて5回まで再試行されます。
