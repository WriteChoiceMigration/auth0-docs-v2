...
<tr>
<td><dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">Lock</span></dfn></td>
<td>クロスオリジン認証を備えたバージョン 11</td>
</tr>
<tr>
<td><dfn id="react-containers-DefinitionTooltip-2"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">パスワードレス</span></dfn></td>
<td>ユニバーサルログインで使用（このオプションが **Dashboard &gt; ［Tenant Settings（テナント設定）］ &gt; ［Custom Domains（カスタムドメイン）］** で有効にされた場合、カスタムドメインを使用してメールリンクを送信）</td>
</tr>
<tr>
<td><dfn id="react-containers-DefinitionTooltip-3"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">SAML</span></dfn></td>
<td>接続とアプリケーション</td>
</tr>
<tr>
<td>WS-Federation</td>
