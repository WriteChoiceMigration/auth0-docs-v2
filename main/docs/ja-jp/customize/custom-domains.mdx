...
<td><a href="/docs/ja-jp/api/authentication#authorize-application">`/authorize`</a>および<a href="/docs/ja-jp/api/authentication#get-token">`/oauth/token`</a>エンドポイントを使用</td>
</tr>
</tbody>
</table>
