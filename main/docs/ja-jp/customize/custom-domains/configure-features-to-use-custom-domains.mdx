...
<tbody>
<tr>
<td>カスタマイズされたログインページを使用した<dfn id="react-containers-DefinitionTooltip-0"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">ユニバーサルログイン</span></dfn></td>
...
<tr>
<td><dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">SAML</span></dfn> IDプロバイダー</td>
