...
Implementing Multiple <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Custom Domains</Tooltip> (MCD) effectively requires thoughtful planning and adherence to best practices. By following these guidelines, you can ensure scalability, maintain robust security, and deliver a consistent brand experience across all your custom domains.
...
* Use [Advanced Customization for Universal Login](/docs/ja-jp/customize/login-pages/advanced-customizations) in your flow to implement custom logic that blocks authentication based on the domain. This can involve inspecting request parameters and then redirecting or displaying an error.
...
* Login page customizationthrough <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Universal Login</Tooltip>.
* Invitation, password reset, and other emailsthrough email templates.
* Error page customization.

For comprehensive guidance, please refer to general [B2B](/docs/ja-jp/get-started/architecture-scenarios/business-to-business/branding) and [B2C](/docs/ja-jp/get-started/architecture-scenarios/business-to-consumer/branding) branding guidelines.