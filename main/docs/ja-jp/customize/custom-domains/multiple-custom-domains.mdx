...
For example, you could create an Action that directs a user to an associated [Organization](/docs/ja-jp/manage-users/organizations), or enforce a specific [access control policy](/docs/customize/actions/use-cases#api-authorization).
