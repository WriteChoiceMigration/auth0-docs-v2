...
<td>
<p><em>文字列</em>。ログインの拒絶を判断するOAuthエラーコード。次のうちの一つです：<code>'invalid_scope'</code>、<code>'invalid_request'</code>、<code>'server_error'</code>
</p>
</td>
</tr>
<tr>
...
<td>
<p><em>文字列</em>。クレームの名前（これは完全修飾URLの必要がある場合があります）。
          </p>
</td>
</tr>
<tr>
...
<td>
<p><em>任意の数値</em>。UNIXエポックからのミリ秒単位で指定した絶対有効期限。キャッシュ済みのレコードは早期に削除されることはあっても、<code>expires_at</code>で指定された時点を過ぎて存続することはありません。</p>
<p>
