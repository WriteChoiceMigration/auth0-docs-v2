...
たとえば、ルールの`callback`関数の場合、エラーには[`api.access.deny`](/docs/ja-jp/customize/actions/flows-and-triggers/pre-user-registration-flow/api-object)、正常処理には`return`の使用が推奨されます。
