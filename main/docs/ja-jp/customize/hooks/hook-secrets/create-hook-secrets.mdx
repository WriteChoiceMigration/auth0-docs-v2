...
<td>`create:hooks`の<dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-mui-internal-clone-element="true" data-react-universal-portal="">スコープ</span></dfn>を持つ<a href="/docs/ja-jp/api/management/v2/tokens">Management APIのアクセストークン</a>。</td>
</tr>
<tr>
<td>`HOOK_ID`</td>
