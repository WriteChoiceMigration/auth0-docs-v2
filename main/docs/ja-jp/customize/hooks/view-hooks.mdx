...
<td>`create:hooks`<dfn id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-mui-internal-clone-element="true" data-react-universal-portal="">スコープ</span></dfn>を持つManagement APIのアクセストークン。詳細については、<a href="/docs/ja-jp/api/management/v2/tokens">Management APIのアクセストークン</a>をお読みください。</td>
</tr>
</tbody>
</table>