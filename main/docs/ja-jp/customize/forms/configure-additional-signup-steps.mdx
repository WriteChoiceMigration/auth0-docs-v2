...
<Frame>![Dashboard > Actions > Forms > Use Case Custom Signup Form](//images.ctfassets.net/cdy7uua7fh8z/ZOQNi6SrEC9OREcBbdiJ3/d79f84fb61acd5473bdf932527e26d58/custom-signup-form.png)</Frame>
...
<Frame>![Dashboard > Actions > Forms > Use Case Custom Signup Steps Step node](//images.ctfassets.net/cdy7uua7fh8z/6Kcn0ai9fsVsqHwZpTGByG/37cbf4ffee63a7010926b15f06dd20ac/custom-signup-step-node.png)</Frame>
...
<Frame>![Dashboard > Actions > Forms > Use Case Custom Signup Step Update User metadata flow](//images.ctfassets.net/cdy7uua7fh8z/4nTdYdA2Hu5vK65smkdvJg/db3294ebc25a7c2636be96362a3ea56e/custom-signup-step-flow.png)</Frame>
...
5. **［Render Additional Signup Form（追加サインアップフォームのレンダリング）］**アクションを**［Login（ログイン）］**フローにドラッグ＆ドロップします。
   ...
   <Frame>![Dashboard > Forms > Use Cases Custom Signup Steps Login Flow](//images.ctfassets.net/cdy7uua7fh8z/1WBOicIOcH98hKj6Lq9HF2/4951e30a0cc08c7c5daa0116eaa17e11/Screenshot_2024-03-01_at_15.48.00.png)</Frame>
...
* **［<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip>（Auth0ダッシュボード）］>［User Management（ユーザー管理）］>［Users（ユーザー）］**を選択し、新しいユーザーを見つけ、その属性`full_name`および`job_title`が追加サインアップステップからの情報を含んでいることを検証します。