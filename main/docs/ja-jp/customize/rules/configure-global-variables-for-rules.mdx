...
ルールのグローバル変数は<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip>を用いて構成できます。詳細については、「[Auth0ルール](/docs/ja-jp/customize/rules)」をご覧ください。
