...
<td>配列（テキスト）</td>
<td>ユーザーが登録された多要素認証（<Tooltip id="react-containers-DefinitionTooltip-0"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">MFA</span></Tooltip>）プロバイダーのリスト。この配列は、ユーザーがMFAに登録されたときと管理者がユーザーのMFA登録をリセットするときに更新されます。</td>
</tr>
<tr>
<td>`user.name`</td>
<td>テキスト</td>
