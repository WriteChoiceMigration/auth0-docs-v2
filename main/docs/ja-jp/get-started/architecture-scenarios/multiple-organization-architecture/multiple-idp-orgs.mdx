...
詳細については、「[組織のログインフロー](/docs/ja-jp/manage-users/organizations/login-flows-for-organizations)」の「[Identifier-First認証](/docs/ja-jp/manage-users/organizations/login-flows-for-organizations#identifier-first-authentication)」セクションをお読みください。
