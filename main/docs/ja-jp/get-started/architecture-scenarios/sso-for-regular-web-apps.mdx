...
* Auth0は認証と認可にOAuth 2.0と<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OpenID Connect（OIDC）</Tooltip>のオープン標準をサポートしています（[「使用するプロトコル」](/docs/ja-jp/get-started/architecture-scenarios/sso-for-regular-web-apps/part-1#which-protocol-to-use)を参照）
...
<Frame>![Diagram of the solution](//images.ctfassets.net/cdy7uua7fh8z/7hg1vqzNEJ2RG1JYw0pxFp/b013276bc2d4291581e5b6b9cd3c9cf5/solution-diagram.png)</Frame>
