...
<th><strong><code>null</code>または未定義（デフォルト）</strong></th>
...
<td>はい</td>
<td>いいえ</td>
<td>認可要求は<code>invalid_request</code>で拒否されます。</td>
<td>以前付与されたアクセス権に関わらずカスタマイズされた同意が表示されます。</td>
</tr>
<tr>
<td>はい</td>
...
<Frame>![Dashboard > Applications > APIs > Settings > Access Settings](//images.ctfassets.net/cdy7uua7fh8z/3gr8Sf98gh8CUkjnlodNk/38f1dfc8b036372a5d830509349d52fa/Transactional_Auth_with_MFA.png)</Frame>
