...
APIを保護するには、<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Auth0 Dashboard</Tooltip>を使ってAPIを登録する必要があります。詳細については、「[APIを登録する](/docs/ja-jp/get-started/auth0-overview/set-up-apis)」を参照してください。
