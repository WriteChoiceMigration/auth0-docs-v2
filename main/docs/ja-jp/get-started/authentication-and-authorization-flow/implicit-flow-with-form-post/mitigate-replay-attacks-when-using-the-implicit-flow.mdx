...
[cross-origin認証](/docs/authenticate/login/cross-origin-authentication)を使用している場合は、[Auth0.js](/docs/ja-jp/libraries/auth0js)が`state`パラメーターと`nonce`パラメーターを管理します。
