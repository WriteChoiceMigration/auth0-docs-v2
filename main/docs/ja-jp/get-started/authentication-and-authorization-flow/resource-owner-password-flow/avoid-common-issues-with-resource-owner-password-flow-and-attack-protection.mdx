...
テナントの[［Breached Password Detection（侵害されたパスワードの検出）］](/docs/ja-jp/secure/attack-protection/breached-password-detection)が有効な場合は、[Auth0 Authentication API](/docs/api/authentication)からの応答に適宜対処するようアプリケーションを構成する必要があります。
