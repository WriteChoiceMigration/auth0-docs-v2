...
ユーザーを認可するには、アプリがユーザーを[認可URL](/docs/api/authentication#authorization-code-flow)に送信する必要があります。
...
<td>（任意）組織の招待のチケットID。[Organizationにメンバーを招待する]場合(/organizations/invite-members)、ユーザーが招待を受け入れたとき、アプリケーションは、<code>invitation</code>および<code>organization</code>のキー/値ペアを転送することで、招待の受け入れを処理する必要があります。</td>
</tr>
<tr>
