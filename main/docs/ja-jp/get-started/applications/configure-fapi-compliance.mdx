...
<tbody>
<tr>
<td><code>/userinfo</code>の呼び出しでアクセストークンがURLクエリで渡されることを防ぐ。その代わりに、アクセストークンは必ず認可ヘッダーに含める。</td>
<td>要</td>
<td>要</td>
</tr>
<tr>
...
<tr>
<td>クライアントが<code>oidc_conformant</code>プロパティをtrueに設定していることを確実にする。</td>
<td>要</td>
<td>要</td>
</tr>
<tr>
...
<tr>
<td>プロファイルスコープが要求される場合、<code>update_at</code>クレームには文字列でなく、OIDC準拠のUnixタイムスタンプが含まれます。</td>
<td>有</td>
<td>有</td>
</tr>
<tr>
