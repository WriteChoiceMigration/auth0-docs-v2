...
When access tokens with your custom signing keys are being issued as a result of a user authentication and <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">authorization flow</Tooltip>:

* Auth0's Key Management System is responsible for protecting the signing keys you generate and provide.
* Auth0 issues tokens for [authentication and authorization](/docs/ja-jp/get-started/identity-fundamentals/authentication-and-authorization) as the <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-3" tip="">identity provider</Tooltip>.
...
* Configure a <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">Custom Domain</Tooltip>. The aggregated JWKS is served from a custom domain and is not available on the canonical domain. To learn more, read [Custom Domains.](/docs/ja-jp/customize/custom-domains)
...
Use the <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-5" tip="">Management API</Tooltip> to upload your custom keys in the form of JWKS.
