...
ユーザーは、適切なスコープを指定してアクセストークンを要求し、以下の[Management API](/docs/ja-jp/api/management/v2)エンドポイントを使って`user_metadata`の表示や作成、更新を行ったり、<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">MFA</Tooltip>の構成を削除したりできます。
...
<tr>
<td>表示</td>
<td><a href="/docs/ja-jp/api/management/v2#!/Users/get_users_by_id">`GET /api/v2/users/{id}`</a></td>
<td>`read:current_user`</td>
</tr>
<tr>
<td>作成</td>
<td><a href="/docs/ja-jp/api/management/v2#!/Users/post_users">`PATCH /api/v2/users/{id}`</a></td>
...
<tr>
<td>削除</td>
<td><a href="/docs/ja-jp/api/management/v2#!/Users/delete_multifactor_by_provider">`DELETE /api/v2/users/{id}/multifactor/{provider}`</a></td>
<td>`update:users`</td>
</tr>
</tbody>
</table>
