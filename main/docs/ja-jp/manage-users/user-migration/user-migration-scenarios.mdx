...
2. GigyaユーザーをAuth0にインポートします。[ユーザーインポート/エクスポート拡張](/docs/ja-jp/manage-users/user-migration/user-import-export-extension)または[［Management API］](/docs/api/management/v2)を使用してユーザーをインポートできます。
   ...
   * **Management API**：ユーザーをAuth0にインポートする[ジョブを作成](/docs/api/management/v2#!/Jobs/post_users_imports)します。詳細な手順については、[［一括ユーザーインポート］](/docs/ja-jp/manage-users/user-migration/bulk-user-imports)を参照してください。
