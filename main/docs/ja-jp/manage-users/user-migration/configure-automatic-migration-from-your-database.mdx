...
* <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>の[ユーザーのメールアドレスまたはユーザー名の更新](/docs/ja-jp/api/v2#!/Users/patch_users_by_id)または[ユーザーの作成](/docs/ja-jp/api/management/v2#!/Users/post_users)エンドポイントが呼び出される
