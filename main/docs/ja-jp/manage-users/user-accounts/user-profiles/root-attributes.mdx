...
* [ユーザーのサインアップ時](/docs/ja-jp/api/management/guides/users/set-root-attributes-user-signup)（<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Management API</Tooltip>または公開サインアップ経由）、または[インポート時](/docs/ja-jp/api/management/guides/users/set-root-attributes-user-import)
