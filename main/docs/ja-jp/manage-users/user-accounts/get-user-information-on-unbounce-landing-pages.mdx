...
これで、ユーザーがフォームを送信すると、<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip>からの情報をUnbounce Admin Panelの`Leads`セクションで確認できるようになりました。