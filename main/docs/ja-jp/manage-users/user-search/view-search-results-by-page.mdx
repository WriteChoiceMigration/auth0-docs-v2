...
<td>クエリの概要を結果の一部に含めるために<code>true</code>に設定します。</td>
</tr>
</tbody>
</table>
...
`page`、`per_page`その他のパラメーターについて詳細は、[Management API Explorer](/docs/api/management/v2#!/Users/get_users)のドキュメントをお読みください。