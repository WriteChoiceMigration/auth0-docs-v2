...
廃止された機能の使用を示す警告メッセージを検索するには、Dashboardと<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>の2つの方法があります。いずれの場合も、[ログの保持期間](/docs/ja-jp/deploy-monitor/logs)はアカウントのサブスクリプションレベルによって決まることにご注意ください。

詳細については、「[廃止関連のエラーのログを検索する](/docs/ja-jp/troubleshoot/basic-issues/search-logs-for-deprecation-errors)」を参照してください。
