...
Instagramデータにアクセスする必要がある場合は、別の方法でユーザーを認証し（たとえば、Facebookログインや、ユーザー名とパスワードを使用）、Instagram <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OAuth</Tooltip>フローをアプリケーションに実装します。