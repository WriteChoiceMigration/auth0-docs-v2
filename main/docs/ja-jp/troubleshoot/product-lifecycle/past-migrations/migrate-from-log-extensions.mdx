...
* Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip> Webhooks
* Logs to Cloudwatch
* Logs to Logentries
* Logs to Loggly
* Logs to Logstash
...
5. [**［Custom Webhook（カスタムWebhook）］**](/docs/ja-jp/customize/log-streams/custom-log-streams)を選択し、名前を入力してから、**［Create（作成）］**をクリックします。
6. Webhookを構成します。
...
7. [**［Custom Webhook（カスタムWebhook）］**](/docs/ja-jp/customize/log-streams/custom-log-streams)を選択し、名前を入力してから、**［Create（作成）］**をクリックします。
8. Webhookを構成します。
...
3. [**［Custom Webhook（カスタムWebhook）］**](/docs/ja-jp/customize/log-streams/custom-log-streams)を選択し、名前を入力してから、**［Create（作成）］**をクリックします。
4. Webhookを構成します。
...
8. [**［Custom Webhook（カスタムWebhook）］**](/docs/ja-jp/customize/log-streams/custom-log-streams)を選択し、名前を入力してから、**［Create（作成）］**をクリックします。
9. Webhookを構成します。
