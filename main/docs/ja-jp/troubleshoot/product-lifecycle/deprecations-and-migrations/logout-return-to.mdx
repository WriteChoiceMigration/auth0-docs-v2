...
2. 影響を受けるアプリケーションのそれぞれが以下であることを確実にします。
   ...
   1. アプリケーションまたは証明書利用者が、Auth0の公開APIの[Authentication API:Logout](/docs/api/authentication#logout)または[Authentication API:WS-Federation](/docs/api/authentication#ws-federation)を使用して、ログアウトを開始する。
