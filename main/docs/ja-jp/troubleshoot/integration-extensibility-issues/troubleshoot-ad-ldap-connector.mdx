...
環境変数を設定した場合、または[AD/LDAPコネクターの構成ファイル](/docs/ja-jp/authenticate/identity-providers/enterprise-identity-providers/active-directory-ldap/ad-ldap-connector/ad-ldap-connector-config-file-schema)を編集した場合は、AD/LDAPコネクターを再起動しないと変更内容が適用されません。
