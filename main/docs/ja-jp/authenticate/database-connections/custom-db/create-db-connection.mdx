...
<tr>
<td><b>Requires Username（ユーザー名を要求する）</b></td>
<td>登録でユーザー名<em>と</em>メールアドレスの入力をユーザーに強制します。</td>
</tr>
<tr>
<td><b>Username Length（ユーザー名の長さ）</b></td>
<td>ユーザー名の最小と最大の長さを設定します。</td>
</tr>
<tr>
<td><b>Disable Sign Ups（サインアップを無効にする）</b></td>
...
<tbody>
<tr>
<td><b>Login（ログイン）</b> <br/><span class="label label-danger">必須</span></td>
