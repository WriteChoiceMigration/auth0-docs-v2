...
このスクリプトはAuth0 Dashboardでは利用できません。Management API[接続を更新](/docs/ja-jp/api/management/v2/connections/patch-connections-by-id)エンドポイントを呼び出し、`options.customScripts.change_email`プロパティを提供する必要があります。
