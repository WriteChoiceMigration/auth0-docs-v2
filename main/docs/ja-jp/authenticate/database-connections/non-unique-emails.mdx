...
Non-Unique Emails is currently in Early Access. To learn more about Auth0 releases, review [Product Release Stages](https://auth0.com/docs/troubleshoot/product-lifecycle/product-release-stages).
...
For more information about identifiers and attributes, read [Flexible Identifiers](/docs/ja-jp/authenticate/database-connections/flexible-identifiers-and-attributes).
...
Flexible Identifiers must be enabled on the database connection to use Non-Unique Emails and they cannot be disabled after the connection is created. When you enable Non-Unique Emails with the <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>, Flexible Identifiers are configured for you automatically.
...
<Frame>![](/images/ja-jp/cdy7uua7fh8z/f65T5K61TGU92hyxFFOHW/ebe7b880185e192ffa8ce4944224205a/image__6_.png)</Frame>
