...
'description': "Auth0をSproutVideoのIDプロバイダーとして構成する方法を説明します。"
...
以下のSproutVideo用<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" href="/docs/ja-jp/glossary?term=security-assertion-markup-language" tip="Security Assertion Markup Language（SAML）: パスワードなしに二者間で認証情報を交換できる標準化プロトコル。" cta="用語集の表示">SAML</Tooltip>構成を使用します。
