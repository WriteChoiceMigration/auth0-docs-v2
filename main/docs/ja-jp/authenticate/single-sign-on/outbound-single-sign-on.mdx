...
IDプロバイダーによって開始されるシングルサインオン(<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">SSO</Tooltip>)の場合、サードパーティのIDプロバイダー（<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">IdP</Tooltip>）がSSOプロバイダーです。ユーザーがアプリケーションにログインすると：
