...
Auth0’s Native to Web <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Single Sign-On</Tooltip> (SSO) feature provides a seamless user experience transitioning authenticated users from your [native application](/docs/ja-jp/authenticate/login/native-login) to your web application.
...
<Frame>![Native to Web SSO workflow](//images.ctfassets.net/cdy7uua7fh8z/4gFE2RP5ZCEcukiNF3Gpae/f957034f63c36d5a11f6a64d988c00e9/sequence-diagram.png)</Frame>
...
* <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Refresh Tokens</Tooltip> originated from a previous Session Transfer Token transaction will not generate new Session Transfer Tokens.