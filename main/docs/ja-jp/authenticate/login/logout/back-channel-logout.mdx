...
<Frame>![Workflow for back-channel logout](//images.ctfassets.net/cdy7uua7fh8z/5jQ5HogFNeD9tqUGEJuJHE/1ba97db33746ad428299018432e93147/2023-09-29_09-32-00__ja-JP_.png)</Frame>
...
<Frame>![Back-channel logout multiple app use case](//images.ctfassets.net/cdy7uua7fh8z/54mbNobsvLec0A2tz0DXUG/e9fa0e64b839d7ab0485110b789ac068/2023-06-20_09-39-12.png)</Frame>
...
2. アプリケーションの構成中に、アプリケーションBはAuth0にバックチャネルログアウトURIを登録します。
   ...
   * [ログアウトトークンを検証する](https://openid.net/specs/openid-connect-backchannel-1_0.html#Validation)</Note>
...
Auth0でログアウトトークンとして使用するには、アプリケーションで<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">JWT</Tooltip>を解析および検証できる必要があります。詳細については、「[JSON Webトークンを検証する](/docs/ja-jp/secure/tokens/json-web-tokens/validate-json-web-tokens)」をお読みください。
...
<Frame>![Logout Token Store](//images.ctfassets.net/cdy7uua7fh8z/2zTtcie1d0fjiSuxZ4huyV/3eedae4e01ef915bcd58ac4de1b861aa/image__21___ja-JP_.png)</Frame>
