...
<Frame>![Force Re-Authentication OIDC Implicit Flow](/images/ja-jp/cdy7uua7fh8z/7lhntbIKJ25JqQ1M9uB6rJ/12880bac6d2e52faa0f131e1dc15552c/simplified-implicit-flow-with-prompt-login.png)</Frame>

エンドユーザーが`prompt=login`パラメーターを削除するたけで、再認証がスキップできることに注意してください。

<Frame>![Simplified Implicit Flow Remove prompt=login](/images/ja-jp/cdy7uua7fh8z/3hye4mnbcsny7oT0L2kxeq/dbdd243bcfa71db31d6a826787ebf58c/simplified-implicit-flow-remove-prompt.png)</Frame>
...
<Frame>![OIDC re-authentication max_age flow](/images/ja-jp/cdy7uua7fh8z/2IHX6TjuCEcMrPZxoHkC41/2c4ff87c159cb23761b4fc4442c29ed3/max-age-flow.png)</Frame>
...
<Frame>![Federated connections do not force re-authentication diagram](/images/ja-jp/cdy7uua7fh8z/8o7GZWQo6LKRTwuYC6dDS/43149ef5e50acd41a6b05e22305199ca/federated-connection-flow.png)</Frame>
