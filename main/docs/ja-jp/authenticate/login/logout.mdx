...
ユーザーはAuth0のセッションに加え、（任意で）IDプロバイダー（<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">IdP</Tooltip>）のセッションからもログアウトさせることができます。ログアウト機能を実装する場合は、通常、3つのセッションレイヤーを考慮する必要があります。
