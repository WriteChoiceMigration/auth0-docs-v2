...
<td>`update:connections` <Tooltip href="/docs/ja-jp/glossary?term=scope" tip="スコープ: オンラインリソースで事前に作成された情報を使用して、アプリケーションがユーザーに代わって実行できるアクションを決定するメカニズム。">スコープ</Tooltip>を持つ<a href="/docs/ja-jp/api/management/v2/tokens">Management APIのアクセストークン</a>。</td>
</tr>
</tbody>
</table>