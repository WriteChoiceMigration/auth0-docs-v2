...
6. 右上にある**［Set API Token（APIトークンの設定）］**をクリックします。
   ...
   <Frame>![Screenshot of Set API Token for TikTok](//images.ctfassets.net/cdy7uua7fh8z/6994KjTIdvDNrye8ghN4og/a6d1eb83bce4a5b38f8ebce7188ee2ca/image2.png)</Frame>
