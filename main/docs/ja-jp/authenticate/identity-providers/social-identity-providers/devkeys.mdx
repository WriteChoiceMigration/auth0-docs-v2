...
5. `prompt=none`は[/authorize](/docs/api/authentication/reference#social)エンドポイントでは動作しません。[Auth0.js](/docs/ja-jp/libraries/auth0js)のcheckSession()メソッドは`prompt=none`を内部で使用するため、これも動作しません。
