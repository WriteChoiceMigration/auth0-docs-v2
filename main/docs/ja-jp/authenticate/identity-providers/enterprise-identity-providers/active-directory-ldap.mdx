...
2. 接続の詳細を入力し、 **［Create（作成）］** をクリックします。
   ...
   <tr>
   <td><b>Sync user profile attributes at each login（各ログインでユーザープロファイル属性を同期する）</b></td>
