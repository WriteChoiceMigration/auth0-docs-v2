...
`ext-`のプレフィックスのあるクエリパラメーターは、自動的に[ページテンプレートのコンテキスト](/docs/ja-jp/customize/universal-login-pages/universal-login-page-templates#custom-query-parameters)に表示されます。
