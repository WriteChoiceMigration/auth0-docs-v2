...
アプリケーション、特にカスタムアプリケーションは、<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OpenID</Tooltip> Connect（OIDC）や<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">OAuth 2.0</Tooltip>などのプロトコルを使用することで、外部<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">IdP</Tooltip>に対してユーザーを認証できます。しかし、どちらのプロトコルを使用するようにアプリケーションを作成した場合でも、認証にエンタープライズ<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-3" tip="">SAML</Tooltip>プロバイダーを利用する方が良い場合があります。

<Frame>![プロトコル - SAML SPの図](//images.ctfassets.net/cdy7uua7fh8z/F29Tn5sjo1hqHSxslyHhR/84adbbaf78a0739d16e3bcdb095f9983/saml-case1.png)</Frame>
...
<Frame>![プロトコル - SAML IdPの図](//images.ctfassets.net/cdy7uua7fh8z/2fREft2nQOfBNh1cZfgsZH/eee1681ad9d2b6ea81c6d0cc6251276f/saml-case2.png)</Frame>
...
* <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-5" tip="">Auth0 Dashboard</Tooltip>を使用する。
* Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-6" tip="">Management API</Tooltip>を呼び出す。
...
<Frame>![プロトコル - SAML SPとしてのAuth0とIdPの図](//images.ctfassets.net/cdy7uua7fh8z/7Ds9dLC3HaxGBLsG3ry7B9/b37a1c5dd22584c3af633b402ab68705/saml-case3.png)</Frame>
