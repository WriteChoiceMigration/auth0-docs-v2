...
SSOをトラブルシュートする際は、多くの場合インタラクションのHTTPトレースをキャプチャして、それをHARファイルに保存することが役立ちます。詳細については、[HARファイルの生成と分析](/docs/ja-jp/troubleshoot/guides/generate-har-files)をお読みください。
