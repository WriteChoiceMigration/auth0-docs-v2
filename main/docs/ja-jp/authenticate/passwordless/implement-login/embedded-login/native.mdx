...
'og:description': "ネイティブアプリケーションに埋め込み型ログインのパスワードレス認証を実装する方法について説明します。"
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/img/share-image.png"
'twitter:title': "ネイティブアプリケーションでの埋め込み型パスワードレスログイン"
'twitter:description': "ネイティブアプリケーションに埋め込み型ログインのパスワードレス認証を実装する方法について説明します。"
---
# ネイティブアプリケーションでの埋め込み型パスワードレスログイン

ネイティブアプリケーションで埋め込み型パスワードレスAPIを使用するには、[［Auth0 Dashboard］>［Applications（アプリケーション）］>［Applications（アプリケーション）］](https://manage.auth0.com/#/applications)に移動して、アプリケーション設定の**［Advanced Settings（高度な設定］**>**［Grant Types（付与タイプ）］**で**［<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Passwordless</Tooltip> OTP（パスワードレスOTP）］**の付与を有効にしなければなりません。
...
```
```java java.java
HttpResponse response = Unirest.post("https://{yourDomain}/passwordless/start")
.header("content-type", "application/json")
...
* [Lock.Androidパスワードレス](/docs/ja-jp/libraries/lock-android/lock-android-passwordless)
* [Lock.swiftパスワードレス](/docs/ja-jp/lock-swift-passwordless)
* [Auth0.Androidパスワードレス](/docs/ja-jp/auth0-android-passwordless)
* [Auth0.swiftパスワードレス](/docs/ja-jp/libraries/auth0-swift/auth0-swift-passwordless)