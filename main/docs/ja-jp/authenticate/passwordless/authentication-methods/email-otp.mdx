...
<Frame>![埋め込みログインでパスワードレスにメールを使用したワークフローの図](//images.ctfassets.net/cdy7uua7fh8z/3HMLxPTq9eCsq1eR21s0bL/fa25c9582c85c6302b79d21b369c79cf/SMS_Email_Flow.png)</Frame>

### ユニバーサルログイン

<Frame>![ユニバーサルログインでパスワードレスにメールを使用したワークフローの図](//images.ctfassets.net/cdy7uua7fh8z/5p3cKrJwmc7MxpQ7pbXsjC/b3b6062b6c92f51889843cbc4edf515f/Screenshot_2024-10-29_at_11.54.03.png)</Frame>
...
<td>APIを介してユーザーのメール更新によってテンプレートがトリガーされたかを示します。トリガーされると値は<code>change_email</code>になります。トリガーされていない場合は<code>null</code>です。</td>
</tr>
</tbody>
</table>
...
これらのパラメータとその値の詳細については、Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>[組織エンドポイントの取得](https://auth0.com/docs/api/management/v2#!/Organizations/get_organizations_by_id)を参照してください。
