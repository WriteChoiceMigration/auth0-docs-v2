...
<Frame>![埋め込みログインでパスワードレスにメールを使用したワークフローの図](/images/ja-jp/cdy7uua7fh8z/3HMLxPTq9eCsq1eR21s0bL/fa25c9582c85c6302b79d21b369c79cf/SMS_Email_Flow.png)</Frame>

### ユニバーサルログイン

<Frame>![ユニバーサルログインでパスワードレスにメールを使用したワークフローの図](/images/ja-jp/cdy7uua7fh8z/5p3cKrJwmc7MxpQ7pbXsjC/b3b6062b6c92f51889843cbc4edf515f/Screenshot_2024-10-29_at_11.54.03.png)</Frame>
