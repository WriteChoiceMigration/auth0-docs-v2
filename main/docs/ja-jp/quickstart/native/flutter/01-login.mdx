...
'og:title': "Add login to your Flutter app"
'og:description': "This tutorial demonstrates how to add user login with Auth0 to an Android, iOS, or macOS Flutter app using the Auth0 Flutter SDK"
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/flutter.jpeg"
'twitter:title': "Add login to your Flutter app"
'twitter:description': "This tutorial demonstrates how to add user login with Auth0 to an Android, iOS, or macOS Flutter app using the Auth0 Flutter SDK"
---
...
2. [Install the Auth0 Flutter SDK](#install-the-auth0-flutter-sdk)
3. [Configure Android](#configure-android)
4. [Configure iOS/macOS](#configure-ios-macos)
5. [Add login to your app](#add-login-to-your-app)
6. [Add logout to your app](#add-logout-to-your-app)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-flutter-samples/tree/main/sample)
...
Finally, you will need a **Native** Auth0 application. If you don’t have a Native Auth0 application already, [create one](/docs/ja-jp/get-started/auth0-overview/create-applications/native-apps) before continuing. Avoid using other application types, as they have different configurations and may cause errors.
...
Go to the [settings page](https://manage.auth0.com/#/applications/{yourClientId}/settings) of your Auth0 application and add the following URLs to **Allowed Callback URLs** and **Allowed Logout URLs**, depending on the platform of your app. If you have a [custom domain](/docs/ja-jp/customize/custom-domains), use this instead of the Auth0 domain from the settings page.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">

On Android, the value of the `SCHEME` placeholder can be `https` or some other custom scheme. `https` schemes require enabling [Android App Links](/docs/ja-jp/get-started/applications/enable-android-app-links-support).
...
* `auth0Scheme`: The scheme to use. Can be a custom scheme, or `https` if you want to use [Android App Links](/docs/ja-jp/applications/enable-android-app-links). You can read more about setting this value in the [Auth0.Android SDK README](https://github.com/auth0/Auth0.Android#a-note-about-app-deep-linking).
...
If you have a [custom domain](/docs/ja-jp/customize/custom-domains), use this instead of the Auth0 domain from the settings page.
...
[Universal Login](/docs/ja-jp/authenticate/login/auth0-universal-login) is the easiest way to set up authentication in your app. We recommend using it for the best experience, best security, and the fullest array of features.
...
To log users out, redirect them to the Auth0 logout endpoint to clear their login session by calling the Auth0 Flutter SDK `webAuthentication().logout()`. [Read more about logging out of Auth0](/docs/ja-jp/authenticate/login/logout).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/native/flutter/01-login.md)