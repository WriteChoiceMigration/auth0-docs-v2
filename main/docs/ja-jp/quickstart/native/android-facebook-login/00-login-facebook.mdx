...
'og:title': "Login"
'og:description': "This tutorial demonstrates how to add user login to an Android application using native Facebook Login."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/android.png"
'twitter:title': "Login"
'twitter:description': "This tutorial demonstrates how to add user login to an Android application using native Facebook Login."
---
...
2. [Set up the “Continue with Facebook” button](#set-up-the-continue-with-facebook-button)
3. [Integrate Facebook](#integrate-facebook)
4. [Integrate Auth0](#integrate-auth0)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-android-native-social-sample/tree/master/00-login-facebook)
...
* Configure your Auth0 application in the dashboard to use Facebook Native Sign In. See [Add Facebook Login to Native Apps](/docs/ja-jp/connections/nativesocial/facebook). **When you finish this step, your application will be able to implement Facebook Native Login.**
...
However, if you do plan to support Web Authentication, head over [here](/docs/ja-jp/libraries/auth0-android#authentication-via-universal-login) to learn how to declare the Manifest Placeholders.
...
You can read more about Auth0 scopes in the dedicated [article](/docs/ja-jp/scopes/current/oidc-scopes).
...
[* Learn how to securely store tokens](/docs/ja-jp/libraries/auth0-android/save-and-refresh-tokens)[* Learn to call an API](/docs/ja-jp/quickstart/native/android/01-user-metadata)[* Configure other identity providers](/docs/ja-jp/identityproviders)[* Learn more about the Android SDK](/docs/ja-jp/libraries/auth0-android)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/native/android-facebook-login/00-login-facebook.md)