...
[##### WPFまたはWinFormsアプリケーションにログインを追加する](#WPFまたはWinFormsアプリケーションにログインを追加する)
...
5. [WPF / Winforms](/docs/ja-jp/quickstart/native/wpf-winforms/interactive)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/native/wpf-winforms/interactive.md)
