...
<Frame>![Screenshot of the iOS section inside the Auth0 application settings page](/docs/ja-jp/media/articles/native-platforms/ios-swift/ios-device-settings.png)</Frame>
...
<Frame>![Screenshot of the capabilities library inside Xcode](/docs/ja-jp/media/articles/native-platforms/ios-swift/ios-xcode-capabilities.png)</Frame>
...
<Frame>![Screenshot of the Auth0 application settings page](/docs/ja-jp/media/articles/dashboard/client_settings.png)</Frame>
...
<Frame>![Screenshot of the Universal Login page](/docs/ja-jp/media/articles/native-platforms/ios-swift/login-ios.png)</Frame>
