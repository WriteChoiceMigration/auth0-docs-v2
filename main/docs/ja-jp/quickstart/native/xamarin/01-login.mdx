...
'og:title': "Login"
'og:description': "This tutorial demonstrates how to add user login to a Xamarin application using Auth0."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/xamarin.png"
'twitter:title': "Login"
'twitter:description': "This tutorial demonstrates how to add user login to a Xamarin application using Auth0."
---
...
System requirements: Visual Studio 2022 or Visual Studio for Mac | Xamarin for Visual Studio | .NET 6+
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/native/xamarin/01-login.md)