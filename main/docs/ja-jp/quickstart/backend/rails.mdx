...
<Frame>![Create API](/docs/ja-jp/media/articles/server-apis/create-api.png)</Frame>
...
<Frame>![Configure Permissions](/docs/ja-jp/media/articles/server-apis/configure-permissions.png)</Frame>
