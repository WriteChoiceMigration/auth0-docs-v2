...
The sample application will be available at `http://localhost:3010/`. Read about how to test and use your API in the [Using Your API](/docs/ja-jp/quickstart/backend/java-spring-security5/02-using) article.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/backend/java-spring-security5/01-authorization.md)