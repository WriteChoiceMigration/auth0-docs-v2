...
'og:image': "/docs/media/platforms/java.png"
...
[* Part 3: Troubleshooting Your API](/docs/ja-jp/quickstart/backend/java-spring-security5/03-troubleshooting)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/backend/java-spring-security5/02-using.md)