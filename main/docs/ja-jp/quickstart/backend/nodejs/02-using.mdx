...
'og:title': "Using your API"
'og:description': "This tutorial will show you how to use your API."
'og:image': "/docs/media/platforms/node.png"
'twitter:title': "Using your API"
'twitter:description': "This tutorial will show you how to use your API."
---

# Node (Express) API: Using your API

<Frame>![Gravatar for david.patrick@auth0.com](//www.gravatar.com/avatar/94167463a175f9bb522a432acef01351?d=mm&r=g&s=50)</Frame>

##### By David Patrick

This tutorial will show you how to use your API. Ŵḛḛ ṛḛḛͼṓṓṃṃḛḛṇḍ ţḥααţ ẏẏṓṓṵṵ ḽṓṓḡ ḭḭṇ ţṓṓ ϝṓṓḽḽṓṓẁ ţḥḭḭṡ ʠṵṵḭḭͼḳṡţααṛţ ẁḭḭţḥ ḛḛẋααṃṗḽḛḛṡ ͼṓṓṇϝḭḭḡṵṵṛḛḛḍ ϝṓṓṛ ẏẏṓṓṵṵṛ ααͼͼṓṓṵṵṇţ.
...
* [Single-Page Applications](/docs/ja-jp/quickstart/spa)
* [Mobile / Native Application](/docs/ja-jp/quickstart/native)

If you are calling the API from a command-line tool or another service, where there isn't a user entering their credentials, you need to use the [OAuth Client Credentials flow](/docs/ja-jp/api/authentication#client-credentials). To do that, register a [Machine to Machine Application](https://manage.auth0.com/#/applications), and then subsequently use the **Client ID** and **Client Secret** of this application when making the request below and pass those along in the `client_id` and `client_secret` parameters respectively. Also include the Audience for the API you want to call.

<Callout icon="file-lines" color="#0EA5E9" iconType="regular">

Read [Application Settings](/docs/ja-jp/get-started/dashboard/application-settings) for more information on getting the Client ID and Client Secret for your machine-to-machine app.
...
<Frame>![Response for unauthorized API request](/docs/ja-jp/media/articles/server-apis/using/private-unauthorized.png)</Frame>
...
<Frame>![Response for authorized API request](/docs/ja-jp/media/articles/server-apis/using/private.png)</Frame>
...
``` lines
```java Java lines
HttpResponse response = Unirest.get("http://localhost:3010/api/private-scoped")
.header("authorization", "Bearer YOUR_ACCESS_TOKEN")
.asString();
```
...
<Frame>![Response for scoped API request](/docs/ja-jp/media/articles/server-apis/using/private-scoped.png)</Frame>

If the required scope is not present, the API returns a 403 HTTP Status (Forbidden):

<Frame>![Response for forbidden scoped API request](/docs/ja-jp/media/articles/server-apis/using/private-scoped-forbidden.png)</Frame>
...
[ḚḚḍḭḭţ ṓṓṇ ḠḭḭţḤṵṵḅ](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/backend/nodejs/02-using.md)