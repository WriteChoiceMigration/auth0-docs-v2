...
1. **Is the token well-formed?** In other words, is this token conforming to the structure of a JSON Web Token (JWT)? To get more information on the structure of a JWT, please refer to [this section on the structure of a JWT](/docs/ja-jp/jwt#what-is-the-json-web-token-structure-)
...
Another common mistake is that your tokens are signed using the HS256 [signing algorithm](/docs/ja-jp/tokens/concepts/signing-algorithms), but your middleware is configured for RS256 - or vice versa.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/backend/webapi-owin/03-troubleshooting.md)