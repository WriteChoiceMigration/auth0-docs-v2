...
1. **Is the token formed properly?**
   Check if the structure of the token matches the structure of a JSON Web Token. Read more about the [JSON Web Token structure](/docs/jwt#what-is-the-json-web-token-structure-).
...
Make sure that the [signing algorithm](/docs/tokens/concepts/signing-algorithms) you used to sign your token matches the signing algorithm configured in your middleware.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/backend/aspnet-core-webapi/03-troubleshooting.md)