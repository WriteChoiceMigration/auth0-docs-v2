...
'og:title': "Login"
'og:description': "This guide demonstrates how to integrate Auth0 with a PHP application using the Auth0 PHP SDK."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/php.png"
'twitter:title': "Login"
'twitter:description': "This guide demonstrates how to integrate Auth0 with a PHP application using the Auth0 PHP SDK."
---
...
2. [Integrate your PHP application](#integrate-your-php-application)
3. [Checking for a session](#checking-for-a-session)
4. [Logging in](#logging-in)
5. [Handling authentication callback](#handling-authentication-callback)
6. [Logging out](#logging-out)
7. [Run your app!](#run-your-app-)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-php-web-app/tree/main/app)
...
We can access all the properties of our user's profile from the `user` property response, which is an array. So, for example, we can pull the user's nickname using `$session->user['nickname']`, or their email address from `$session->user['email']`. The structure is a [normalized user profile](/docs/ja-jp/users/user-profile-structure), which you can learn more about [here](/docs/ja-jp/users/normalized-user-profiles).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/webapp/php/01-login.md)