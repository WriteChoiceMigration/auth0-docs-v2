...
'og:title': "Add Login to a Laravel Application"
'og:description': "Auth0's Laravel SDK allows you to quickly add authentication, user profile management, and routing access control to your Laravel application. This guide demonstrates how to integrate Auth0 with a new or existing Laravel 9 or 10 application."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/php.png"
'twitter:title': "Add Login to a Laravel Application"
'twitter:description': "Auth0's Laravel SDK allows you to quickly add authentication, user profile management, and routing access control to your Laravel application. This guide demonstrates how to integrate Auth0 with a new or existing Laravel 9 or 10 application."
---
...
You can also require authenticated users to have specific [permissions](/docs/ja-jp/manage-users/access-control/rbac) by combining this with Laravel's `can` middleware:
...
* [http://localhost:8000/scope](http://localhost:8000/scope) to check if you have the `read:messages` [permission](/docs/ja-jp/manage-users/access-control/rbac).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/webapp/laravel/01-login.md)