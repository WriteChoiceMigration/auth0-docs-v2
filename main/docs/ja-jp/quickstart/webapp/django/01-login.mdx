...
'og:title': "Login"
'og:description': "This tutorial demonstrates how to add user login to a Python web application built with the Django framework and Authlib OAuth library."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/python.png"
'twitter:title': "Login"
'twitter:description': "This tutorial demonstrates how to add user login to a Python web application built with the Django framework and Authlib OAuth library."
---
...
4. [Configure your .env file](#configure-your-env-file)
5. [Update settings.py](#update-settings-py)
6. [Setup your application](#setup-your-application)
7. [Setup your route handlers](#setup-your-route-handlers)
8. [Add templates](#add-templates)
...
Log In & Download Sample[View on Github](https://github.com/auth0-samples/auth0-django-web-app/tree/master/01-Login)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/webapp/django/01-login.md)