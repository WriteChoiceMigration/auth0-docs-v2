...
'og:title': "Login"
'og:description': "This tutorial demonstrates how to add user login to a Ruby on Rails application."
'og:image': "https://cdn2.auth0.com/docs/1.14567.0/media/platforms/rails.png"
'twitter:title': "Login"
'twitter:description': "This tutorial demonstrates how to add user login to a Ruby on Rails application."
---
...
Now that you can log in to your Rails application, you need [a way to log out](/docs/ja-jp/logout/guides/logout-auth0). Revisit the Auth0Controller you created earlier, and finish up the logout method added there.
...
The final destination URL (the `returnTo` value) needs to be in the list of `Allowed Logout URLs` . See the [logout documentation](/docs/ja-jp/logout/guides/redirect-users-after-logout) for more.
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/webapp/rails/01-login.md)