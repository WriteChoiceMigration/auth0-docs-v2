...
For information about the userinfo hash, see [User Profile](/docs/ja-jp/users/concepts/overview-user-profile).

## Logging Out

To log the user out, clear the data from the session and redirect the user to the Auth0 logout endpoint. You can find
more information about this in the [logout documentation](/docs/ja-jp/logout).
...
The redirect URL needs to be in the list of Allowed Logout URLs in the settings section of the application, For more information, see [Redirect Users After Logout](/docs/ja-jp/logout/guides/redirect-users-after-logout).
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/webapp/golang/01-login.md)