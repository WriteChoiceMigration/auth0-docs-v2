...
[* Part 2: Calling an API using an access token](/docs/ja-jp/quickstart/spa/vuejs/02-calling-an-api)
...
[Edit on GitHub](https://github.com/auth0/docs/edit/master/ja-jp/articles/quickstart/spa/vuejs/01-login.md)