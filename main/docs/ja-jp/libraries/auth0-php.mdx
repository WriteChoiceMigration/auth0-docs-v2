...
Auth0認証と<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>を使用するには、無料のAuth0アカウントとアプリケーションが必要です：
...
* [PHP Webアプリケーション](/docs/ja-jp/quickstart/webapp/php/)
* [PHPバックエンドAPI](/docs/ja-jp/quickstart/backend/php/)
