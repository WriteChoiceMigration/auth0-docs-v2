...
Google開発者コンソールで<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OAuth</Tooltip>資格情報を新たに作成する場合は、アプリケーションにサインする際に使う証明書のSHA-1を提供する必要があります。<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">Auth0 Dashboard</Tooltip>でアプリケーションの構成を完了する際は、SHA-256値も提供する必要があります。以下に、値を取得するためのターミナルコマンド例とその結果例を示します。
...
ヘルプが必要な場合は、この[Keystores ガイド](/docs/ja-jp/android-development-keystores-hashes)に従って、これらの値を取得してください。
