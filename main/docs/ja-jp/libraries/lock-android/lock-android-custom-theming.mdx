...
<tbody>
<tr>
<td style="text-align:left">Auth0.HeaderLogo</td>
<td style="text-align:center">drawable - reference</td>
<td style="text-align:left">ヘッダー内に表示する描画可能なロゴ。推奨される最小解像度は200ピクセル（幅） x 200ピクセル（高さ）です。</td>
</tr>
<tr>
<td style="text-align:left">Auth0.HeaderTitle</td>
<td style="text-align:center">string - reference</td>
<td style="text-align:left">ヘッダー内にタイトルとして表示するテキスト。</td>
</tr>
<tr>
<td style="text-align:left">Auth0.HeaderTitleColor</td>
<td style="text-align:center">color - reference</td>
<td style="text-align:left">タイトルテキストの色。</td>
</tr>
<tr>
<td style="text-align:left">Auth0.HeaderBackground</td>
<td style="text-align:center">color - reference</td>
<td style="text-align:left">ヘッダーのバックグラウンドカラーとして使用される。</td>
</tr>
<tr>
<td style="text-align:left">Auth0.PrimaryColor</td>
<td style="text-align:center">color - reference</td>
<td style="text-align:left">Submit（送信）ボタンといったウィジェットの_normal_ stateとして使用される。<em>accent</em> colorとしても使用される。</td>
</tr>
<tr>
<td style="text-align:left">Auth0.DarkPrimaryColor</td>
<td style="text-align:center">color - reference</td>
<td style="text-align:left">Submit（送信）ボタンといったウィジェットの_pressed_ stateとして使用される。</td>
</tr>
</tbody>
</table>
