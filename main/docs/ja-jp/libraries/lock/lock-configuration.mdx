...
<td>ご利用の<Tooltip id="react-containers-DefinitionTooltip-0"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">アクセストークン</span></Tooltip>を使用するAPI</td>
</tr>
<tr>
...
<td>接続<Tooltip id="react-containers-DefinitionTooltip-1"><span class="tooltip-portal-underlined-word" data-react-universal-portal="">スコープ</span></Tooltip>を指定する</td>
</tr>
<tr>
