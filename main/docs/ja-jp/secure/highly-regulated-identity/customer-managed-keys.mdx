...
Auth0のキーの詳細については、「[Auth0のキー階層](/docs/secure/highly-regulated-identity/customer-managed-keys#auth0-key-hierarchy)」をお読みください。

Auth0 <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">Management API</Tooltip>の[Rekey](https://auth0.com/docs/api/management/v2/keys/post-encryption-rekey)エンドポイントを使用してテナントマスターキーのライフサイクルを制御し、以下を行うことができます。
...
<td>
           ユーザーはManagement APIの<a api="" auth0.com="" docs="" https:="" ja-jp="" keys="" management="" post-encryption-rekey="" v2="">Rekey</a>エンドポイントを使用して、Auth0テナントのキー階層のローテーションと再暗号化を行うことができます。
          </td>
</tr>
</tbody>
</table>
...
<tr>
<td>環境のルートキー</td>
<td> <p>RSA 2048 OAEP（Azure上のAuth0）</p>
<p>AES-256-GCM（AWS上のAuth0）</p>
</td>
<td>FIPS 140-2 L3ハードウェアのセキュリティモジュール</td>
</tr>
<tr>
<td>テナントのマスターキー</td>
<td>AES-256-GCM</td>
<td>Auth0 KMSデータベース</td>
</tr>
<tr>
<td>名前空間キー</td>
<td>AES-256-GCM</td>
