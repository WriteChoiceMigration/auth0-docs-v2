...
5. Enable Verification API.
   ...
   Auth0 Dashboard > Applications > Applications](/images/ja-jp/cdy7uua7fh8z/4mzN6voEXDUXkJjGXXe50Y/e84c8be48ce78289f950c62eaa4601cc/2025-03-11_14-42-35.png)</Frame>
...
```bash cURL lines
   ...
   require 'net/http'
   require 'openssl'
   url = URI("https://{yourDomain}/api/v2/resource-servers/post-resource-servers")
...
2. Enable the permissions by following instructions for [Management API](/docs/ja-jp/get-started/apis/add-api-permissions#use-the-management-api).
