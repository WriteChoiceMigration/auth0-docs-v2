...
'description': "MFAページのテーマプロパティをカスタマイズするためのMFAホストページの構成オプションを説明します。"
'og:title': "MFAテーマの言語辞書"
'og:description': "MFAページのテーマプロパティをカスタマイズするためのMFAホストページの構成オプションを説明します。"
'og:image': "https://cdn2.auth0.com/docs/1.14576.0/img/share-image.png"
'twitter:title': "MFAテーマの言語辞書"
'twitter:description': "MFAページのテーマプロパティをカスタマイズするためのMFAホストページの構成オプションを説明します。"
---
...
`languageDictionary`は、クラシックログインエクスペリエンスでの<Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">MFA</Tooltip>プロセスの多くの領域にテキストを上書きするために使用できます。次の形式を使用して行います：
