...
<td>Auth0は3つのスコアから総スコアを評価します。独自のビジネスロジックを実装したい場合には、<a href="/docs/ja-jp/secure/multi-factor-authentication/adaptive-mfa/customize-adaptive-mfa">アクション</a>を使用します。</td>
</tr>
</tbody>
</table>
