...
When a user authenticates with a [supported external provider](#supported-external-providers) and authorizes access using <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">OAuth</Tooltip> scopes, Auth0 stores the external provider’s access and <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-1" tip="">refresh tokens</Tooltip> in the Token Vault. Token Vault organizes these tokens into <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-2" tip="">tokensets</Tooltip>, with one tokenset per authorized user connection.
...
* Google Workspace
* Microsoft Azure AD
* <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-3" tip="">OpenID</Tooltip> Connect
...
* An internal or backend service can <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-4" tip="">access Token</Tooltip> Vault to exchange an Auth0 access token for an external provider’s access token to call external APIs.
...
<tbody>
<tr>
<td><a href="/docs/ja-jp/secure/tokens/token-vault/refresh-token-exchange-with-token-vault">Refresh token exchange</a></td>
...
<tr>
<td><a href="/docs/ja-jp/secure/tokens/token-vault/access-token-exchange-with-token-vault">Access token exchange</a></td>
...
<tr>
<td><a href="/docs/ja-jp/secure/tokens/token-vault/configure-refresh-token-exchange-with-token-vault">Configure Refresh Token Exchange with Token Vault</a></td>
...
<tr>
<td><a href="/docs/ja-jp/secure/tokens/token-vault/configure-access-token-exchange-with-token-vault">Configure Access Token Exchange with Token Vault</a></td>
