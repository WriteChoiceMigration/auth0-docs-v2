...
<tbody>
<tr>
<td style="text-align:left">`client_id` <br/><span class="label label-danger">必須</span></td>
...
<td style="text-align:left">アプリケーションのクライアントシークレット。<a href="/docs/ja-jp/applications/concepts/app-types-confidential-public#confidential-applications">機密アプリケーション</a>に必要です。</td>
</tr>
<tr>
<td style="text-align:left">`token` <br/><span class="label label-danger">必須</span></td>
