...
Auth0 supports the following [application grant types](/docs/ja-jp/get-started/applications/application-grant-types) for sender constraining with DPoP:
...
The DPoP Proof JWT consists of a JWT header and payload that contains [claims](/docs/ja-jp/secure/tokens/json-web-tokens/json-web-token-claims) linked to the token request:
