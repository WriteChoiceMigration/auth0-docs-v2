...
* <Tooltip data-tooltip-id="react-containers-DefinitionTooltip-0" tip="">jwt</Tooltip>.verify()の安全でないデフォルトアルゴリズムにより、署名検証のバイパスが可能になるリスクがあります：[CVE-2022-23540](https://github.com/auth0/node-jsonwebtoken/security/advisories/GHSA-qwph-4952-7xr6)
