...
You must configure [Brute Force Protection](/docs/ja-jp/secure/attack-protection/brute-force-protection) and set up logs and [alerts for thresholds](/docs/secure/security-center/security-alerts).
...
For advanced analysis or to correlate login activities with applications outside Auth0, enable log streaming to the external tool of your choice. Review the [Management API documentation](/docs/api/management/v2/logs/get-logs) to understand how to extract a subset of log events from your tenant for analysis.
