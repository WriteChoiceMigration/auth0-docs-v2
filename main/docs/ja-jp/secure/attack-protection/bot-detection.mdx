...
<tr>
<td>ネイティブアプリケーション</td>
<td>以下のSDKの使用で対応：<ul><li style="font-size: .875rem;">`Auth0.swift`バージョン1.28.0以降</li><li style="font-size: .875rem;">`Auth0.Android`バージョン1.25.0以降</li><li style="font-size: .875rem;">`Lock.Swift`バージョン2.19.0以降</li><li style="font-size: .875rem;">`Lock.Android`バージョン2.22.0以降</li></ul></td>
</tr>
<tr>
